...
const exampleRoutes = [
    {
        path: "accessors",
        loadChildren: () => __webpack_require__.e(/*! import() | components-demo-advanced-usage-accessors-chart-docs-accessors-module */ "components-demo-advanced-usage-accessors-chart-docs-accessors-module").then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/accessors/chart-docs-accessors.module */ "VOXW")).then(m => m.ChartDocsAccessorsModule),
    },
    {
        path: "chart-setup",
        loadChildren: () => __webpack_require__.e(/*! import() | components-demo-advanced-usage-chart-setup-chart-docs-chart-setup-module */ "components-demo-advanced-usage-chart-setup-chart-docs-chart-setup-module").then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/chart-setup/chart-docs-chart-setup.module */ "xb04")).then(m => m.ChartDocsChartSetupModule),
    },
    {
        path: "events",
        loadChildren: () => Promise.all(/*! import() | components-demo-advanced-usage-events-chart-docs-events-module */[__webpack_require__.e("common"), __webpack_require__.e("components-demo-advanced-usage-events-chart-docs-events-module")]).then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/events/chart-docs-events.module */ "w47B")).then(m => m.ChartDocsEventsModule),
    },
    {
        path: "grid-config",
        loadChildren: () => __webpack_require__.e(/*! import() | components-demo-advanced-usage-grid-config-chart-docs-grid-config-module */ "components-demo-advanced-usage-grid-config-chart-docs-grid-config-module").then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/grid-config/chart-docs-grid-config.module */ "4SuK")).then(m => m.ChartDocsGridConfigModule),
    },
    {
        path: "legend",
        loadChildren: () => Promise.all(/*! import() | components-demo-advanced-usage-legend-chart-docs-legend-example-module */[__webpack_require__.e("common"), __webpack_require__.e("components-demo-advanced-usage-legend-chart-docs-legend-example-module")]).then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/legend/chart-docs-legend-example.module */ "o7g7")).then(m => m.ChartDocsLegendExampleModule),
    },
    {
        path: "scales",
        loadChildren: () => __webpack_require__.e(/*! import() | components-demo-advanced-usage-scales-chart-docs-scales-module */ "components-demo-advanced-usage-scales-chart-docs-scales-module").then(__webpack_require__.bind(null, /*! components/demo/advanced-usage/scales/chart-docs-scales.module */ "eqoo")).then(m => m.ChartDocsScalesModule),
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("@import \"@nova-ui/bits/bundles/css/styles-font-roboto.css\";\n\n.text-style-roboto {\n    font-family: \"Roboto\";\n}");
