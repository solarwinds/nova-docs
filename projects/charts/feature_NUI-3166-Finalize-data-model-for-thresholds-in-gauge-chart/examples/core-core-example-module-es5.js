(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["core-core-example-module"], {
    ...
    /***/
    function yUe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ChartEventBusTestComponent", function () {
        return ChartEventBusTestComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_chart_event_bus_test_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./chart-event-bus-test.component.html */
      "eGcj");
      /* harmony import */
      ...
      var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! lodash/cloneDeep */
      "BkRI");
      /* harmony import */


      var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */


      var lodash_each__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! lodash/each */
      "xkGU");
      /* harmony import */


      var lodash_each__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(lodash_each__WEBPACK_IMPORTED_MODULE_6__);
      /* harmony import */


      var lodash_includes__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! lodash/includes */
      "ijCd");
      /* harmony import */


      var lodash_includes__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(lodash_includes__WEBPACK_IMPORTED_MODULE_7__);
      /* harmony import */


      var _data_generator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../../../../../data-generator */
      "kBc7");
      /**
      ...
      var ChartEventBusTestComponent = /*#__PURE__*/function () {
        function ChartEventBusTestComponent(logger, changeDetector) {
          _classCallCheck(this, ChartEventBusTestComponent);

          this.logger = logger;
          this.changeDetector = changeDetector;
          this.parsedEvents = [];
          this.eventFilters = [_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["MOUSE_ACTIVE_EVENT"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_VALUES_EVENT"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_DATA_POINTS_EVENT"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["HIGHLIGHT_DATA_POINT_EVENT"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_SERIES_EVENT"]];
          this.interactionTypeFilters = [_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].Click, _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].MouseMove];
        }

        _createClass(ChartEventBusTestComponent, [{
          key: "isEventFilterChecked",
          value: function isEventFilterChecked(filter) {
            return this.selectedEventFilters.indexOf(filter) > -1;
          }
        }, {
          key: "onEventFilterChange",
          value: function onEventFilterChange(filters) {
            this.selectedEventFilters = filters;
          }
        }, {
          key: "isInteractionTypeFilterChecked",
          value: function isInteractionTypeFilterChecked(filter) {
            return this.selectedInteractionTypeFilters.indexOf(filter) > -1;
          }
        }, {
          key: "onInteractionTypeFilterChange",
          value: function onInteractionTypeFilterChange(filters) {
          ...
          value: function ngOnInit() {
            ...
            lodash_each__WEBPACK_IMPORTED_MODULE_6___default()(this.eventFilters, function (eventName) {
              _this.chart.getEventBus().getStream(eventName).subscribe(function (event) {
                if (lodash_includes__WEBPACK_IMPORTED_MODULE_7___default()(_this.selectedEventFilters, eventName)) {
                  if (!event.data.interactionType || lodash_includes__WEBPACK_IMPORTED_MODULE_7___default()(_this.selectedInteractionTypeFilters, event.data.interactionType)) {
                    _this.logger.info("EVENT:", eventName, "DATA:", event.data);

                    _this.parsedEvents.unshift("Event: \"".concat(eventName, "\" Data: ").concat(JSON.stringify(event.data)));

                    _this.parsedEvents = _this.parsedEvents.slice(0, 10);
          ...
          value: function generateDataSeriesSet(dataSeriesCount) {
            var seriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_8__["DataGenerator"].generateMockTimeLineSeriesSet(dataSeriesCount, 40);
            ...
            var accessors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["LineAccessors"]();
            return seriesSet.map(function (dataSeries) {
      ...
      ChartEventBusTestComponent.ctorParameters = function () {
        return [{
      ...
      ChartEventBusTestComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["LoggerService"], _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]])], ChartEventBusTestComponent);
      /***/
    },
    ...
    /***/
    function BNJ9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function KhLy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function PhPh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CoreExampleModule", function () {
        return CoreExampleModule;
      });
      /* harmony import */
      ...
      var _chart_chart_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./chart/chart.example.component */
      "bwYM");
      /* harmony import */


      var _domain_chart_domain_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./domain/chart-domain.example.component */
      "av9s");
      /* harmony import */


      var _event_bus_chart_event_bus_test_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./event-bus/chart-event-bus-test.component */
      "2yUe");
      /* harmony import */


      var _markers_chart_markers_example_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ./markers/chart-markers.example.component */
      "oAtN");
      ...
      var environment = new _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiEnvironment"]();
      environment.logLevel = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["LogLevel"].debug;

      var CoreExampleModule = function CoreExampleModule() {
        _classCallCheck(this, CoreExampleModule);
      };

      CoreExampleModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_chart_chart_example_component__WEBPACK_IMPORTED_MODULE_6__["ChartExampleComponent"], _domain_chart_domain_example_component__WEBPACK_IMPORTED_MODULE_7__["ChartDomainExampleComponent"], _event_bus_chart_event_bus_test_component__WEBPACK_IMPORTED_MODULE_8__["ChartEventBusTestComponent"], _markers_chart_markers_example_component__WEBPACK_IMPORTED_MODULE_9__["ChartMarkersExampleComponent"]],
        imports: [_common_demo_common_module__WEBPACK_IMPORTED_MODULE_5__["DemoCommonModule"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["NuiChartsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiButtonModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiCheckboxModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDocsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiIconModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiSwitchModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(coreRoutes)],
        providers: [{
          provide: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["LoggerService"],
          useValue: new _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["LoggerService"](environment)
        }]
      })], CoreExampleModule);
      /***/
    },
    ...
    /***/
    function SSc7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function av9s(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ChartDomainExampleComponent", function () {
        return ChartDomainExampleComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_chart_domain_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./chart-domain.example.component.html */
      "00YE");
      /* harmony import */
      ...
      var ChartDomainExampleComponent = /*#__PURE__*/function () {
        function ChartDomainExampleComponent(changeDetector) {
          _classCallCheck(this, ChartDomainExampleComponent);
        ...
        _createClass(ChartDomainExampleComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var numCharts = 3;
          ...
          value: function ngAfterViewInit() {
            ...
            var timeLineSeriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_4__["DataGenerator"].generateMockTimeLineSeriesSet(2, 40);

            this.chartComponents.forEach(function (chart, index) {
              _this2.chartAssists.push(new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ChartAssist"](_this2.charts[index]));

              _this2.chartAssists[index].update(_this2.generateChartAssistSeriesSet(timeLineSeriesSet, index));
            });
            this.changeDetector.detectChanges();
          }
        }, {
          key: "generateChartAssistSeriesSet",
          value: function generateChartAssistSeriesSet(dataSeriesSet, chartIndex) {
            var _this3 = this;

            var accessors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["LineAccessors"]();
            return dataSeriesSet.map(function (dataSeries) {
              return Object.assign(Object.assign({}, dataSeries), {
                scales: _this3.scales[chartIndex],
                renderer: _this3.dataRenderer,
                accessors: accessors,
                showInLegend: true
              });
            });
          ...
          key: "fixDomain",
          value: function fixDomain() {
            var startDatetime = new Date("2017-02-15T16:00:00Z");
            var endDatetime = new Date("2017-02-15T16:14:29.909Z");
            this.xScale.fixDomain([startDatetime, endDatetime]);
            this.chartAssists.forEach(function (chartAssist) {
          ...
          value: function refresh() {
            ...
            var seriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_4__["DataGenerator"].generateMockTimeLineSeriesSet(Math.floor(Math.random() * 6), 40);

            this.chartAssists.forEach(function (chartAssist, chartIndex) {
              chartAssist.update(_this4.generateChartAssistSeriesSet(seriesSet, chartIndex));
            });
          }
        }]);
      ...
      ChartDomainExampleComponent.ctorParameters = function () {
        return [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]
        }];
      };
      ...
      ChartDomainExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ChangeDetectorRef"]])], ChartDomainExampleComponent);
      /***/
    },
    ...
    /***/
    function bwYM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ChartExampleComponent", function () {
        return ChartExampleComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_chart_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./chart.example.component.html */
      "BNJ9");
      /* harmony import */


      var _chart_example_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./chart.example.component.less */
      "SSc7");
      /* harmony import */
      ...
      var lodash_zipObject__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! lodash/zipObject */
      "VJLA");
      /* harmony import */


      var lodash_zipObject__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_zipObject__WEBPACK_IMPORTED_MODULE_5__);
      /* harmony import */


      var _data_generator__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../../../data-generator */
      "kBc7");
      /** @ignore */


      var statuses = ["down", "critical", "warning", "unknown", "up"];
      /**
       * This is here just to test a prototype of angular component, that will use new chart core
       *
       * @ignore
      ...
      var ChartExampleComponent = /*#__PURE__*/function () {
        function ChartExampleComponent() {
          _classCallCheck(this, ChartExampleComponent);
        ...
        _createClass(ChartExampleComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            // status chart setup
            ...
            var xScale = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["LinearScale"]();
            this.statusScales = {
              x: xScale,
            ...
            this.statusScales.x.formatters.tick = function (value) {
          ...
          key: "isStatusSignificant",
          value: function isStatusSignificant(highlightedValue) {
            return highlightedValue !== "unknown" && highlightedValue !== "up";
          }
        }, {
          key: "generateStatusSeriesSet",
          value: function generateStatusSeriesSet(dataSeriesCount) {
            var _this5 = this;

            var statusSeriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_6__["DataGenerator"].generateMockStatusSeriesSet(dataSeriesCount, 20, statuses);

            var accessors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["LineAccessors"](this.statusChartAssist.palette.standardColors);
            return statusSeriesSet.map(function (dataSeries) {
              return Object.assign(Object.assign({}, dataSeries), {
                scales: _this5.statusScales,
                renderer: _this5.statusLineRenderer,
                accessors: accessors,
                showInLegend: true
              });
            });
      ...
      ChartExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function eGcj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function oAtN(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ChartMarkersExampleComponent", function () {
        return ChartMarkersExampleComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_chart_markers_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./chart-markers.example.component.html */
      "KhLy");
      /* harmony import */
      ...
      var ChartMarkersExampleComponent = /*#__PURE__*/function () {
        function ChartMarkersExampleComponent() {
          _classCallCheck(this, ChartMarkersExampleComponent);
        ...
        _createClass(ChartMarkersExampleComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.dataScales.x.formatters.tick = function (value) {
              return Math.round(value).toString();
            };
          ...
          value: function updateData() {
            var data = this.generateDataSeriesSet(12, this.dataScales);
          ...
          key: "generateDataSeriesSet",
          value: function generateDataSeriesSet(dataSeriesCount, scales) {
            var renderer = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["LineRenderer"]();

            var lineSeriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_4__["DataGenerator"].generateMockLineSeriesSet(dataSeriesCount, 20);

            var accessors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["LineAccessors"](this.chartAssist.palette.standardColors, this.markers);
            return lineSeriesSet.map(function (dataSeries) {
              return Object.assign(Object.assign({}, dataSeries), {
                accessors: accessors,
                scales: scales,
                renderer: renderer,
          ...
          key: "onSwitchMarkers",
          value: function onSwitchMarkers(value) {
      ...
      ChartMarkersExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
...
//# sourceMappingURL=core-core-example-module-es5.js.map