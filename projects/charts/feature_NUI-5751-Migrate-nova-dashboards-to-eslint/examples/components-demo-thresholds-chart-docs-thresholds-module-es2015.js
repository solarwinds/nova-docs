...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSummaryVisualTestComponent", function() { return ThresholdsSummaryVisualTestComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_summary_visual_test_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-summary-visual-test.component.html */ "IZgm");
...
let ThresholdsSummaryVisualTestComponent = class ThresholdsSummaryVisualTestComponent {
    constructor() {
        this.singleSeries = { "series-1": [30, 95, 15, 60, 35] };
        this.thresholdEdges = { "series-1": [30, 80, 80, 80, 45, 60, 10, 35] };
        this.singleSeriesNoHits = { "series-1": [30, 55, 25, 55, 35] };
        this.multipleSeries = { "series-1": [30, 95, 15, 60, 35], "series-2": [100, 40, 70, 45, 90] };
        this.zones = [
...
ThresholdsSummaryVisualTestComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSparkExampleComponent", function() { return ThresholdsSparkExampleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_spark_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-spark.example.component.html */ "u9+C");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let ThresholdsSparkExampleComponent = class ThresholdsSparkExampleComponent {
    constructor(thresholdsService) {
        this.thresholdsService = thresholdsService;
        this.statusBgColors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["MappedValueProvider"]({
            [Status.Error]: addOpacity(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["CHART_PALETTE_CS_S"][1], 0.2),
            [Status.Warning]: addOpacity(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["CHART_PALETTE_CS_S"][2], 0.3),
        }, "transparent");
        this.statusIcons = { [Status.Error]: "status_critical", [Status.Warning]: "status_warning" };
    ...
    ngOnInit() {
        ...
        this.accessors.data.status = (d) => (lodash_get__WEBPACK_IMPORTED_MODULE_5___default()(d, "__thresholds.status"));
        const seriesSet = getLineSeries(this.xScale, this.renderer, this.accessors);
        // Zone definitions tell the threshold service where threshold zones begin and end
        const zoneDefinitions = getZoneDefinitions();
        const sparks = seriesSet.map(s => {
            // It's possible to manually define zones by area-like data series with start/end values for every data point. We don't do that
            ...
            // Note that the x scale is shared between the foreground series and the background series.
            // Also note that the y band scale fixes the domain to a single value of STATUS_DOMAIN
            const bgScales = { x: s.scales.x, y: new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["BandScale"]().fixDomain(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["StatusAccessors"].STATUS_DOMAIN) };
            // This injects threshold data into every data point of the source series. It is important, because later we can
            // access related threshold information from many different places such as the legend.
            this.thresholdsService.injectThresholdsData(s, zones);
            // We can use the thresholds service to create the background series for each spark
...
ThresholdsSparkExampleComponent.ctorParameters = () => [
    { type: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ThresholdsService"] }
];
ThresholdsSparkExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "nui-thresholds-spark-example",
...
function getLineSeries(xScale, renderer, accessors) {
    const baseDate = moment_moment__WEBPACK_IMPORTED_MODULE_6___default()([2016, 11, 25]);
    const interval = moment_moment__WEBPACK_IMPORTED_MODULE_6___default.a.duration(1, "hours");
    const series = [
        {
            id: "shared-pool-size",
            name: "Shared pool size",
    ...
    return series.map(s => (Object.assign(Object.assign({}, s), { data: getTimeData(s.values, baseDate, interval), scales: {
            x: xScale,
...
function addOpacity(c, opacity) {
    const color = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["getColorValueByName"])(c);
    const rgbColor = Object(d3_color__WEBPACK_IMPORTED_MODULE_4__["rgb"])(color);
    rgbColor.opacity = opacity;
    return rgbColor.toString();
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSummaryExampleComponent", function() { return ThresholdsSummaryExampleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_summary_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-summary.example.component.html */ "MZ3U");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nova-ui/charts */ "gKry");
...
let ThresholdsSummaryExampleComponent = class ThresholdsSummaryExampleComponent {
    constructor(thresholdsService) {
        this.thresholdsService = thresholdsService;
    }
    ngOnInit() {
        // When instantiating the charts, use the provided grid configuration functions for the main grid and summary grid
        const mainChart = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["Chart"](new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["XYGrid"](Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["thresholdsTopGridConfig"])()));
        const summaryChart = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["Chart"](new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["XYGrid"](Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["thresholdsSummaryGridConfig"])()));
        ...
        this.summaryChartAssist = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ChartAssist"](summaryChart);
        ...
        const sharedXScale = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["TimeScale"]();
        const mainChartDataScales = {
            x: sharedXScale,
            y: new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["LinearScale"](),
        };
        // Set the left scale ID on the main chart grid to let it know which scale to use for the left axis ticks
        mainChart.getGrid().leftScaleId = mainChartDataScales.y.id;
        ...
        mainChartDataScales.y.domainCalculator = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["getAutomaticDomainWithIncludedInterval"])([0, 100]);
        ...
        this.thresholdsPalette = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ChartPalette"](new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["MappedValueProvider"]({
            ...
            [Status.Ok]: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["CHART_PALETTE_CS_S"][4],
        }, "transparent"));
        ...
        const mainChartDataSeriesSet = getData().map(d => (Object.assign(Object.assign({}, d), { accessors,
            renderer, scales: mainChartDataScales })));
        // Zone definitions tell the threshold service where threshold zones begin and end
        const zoneDefinitions = getZoneDefinitions();
    ...
    createMainChartThresholdSeriesSet(mainChartDataSeriesSet, mainChartDataScales, zoneDefinitions) {
    ...
    createSummarySeriesSet(seriesSet, xScale, zoneDefinitions) {
        ...
        const thicknessMap = { [Status.Ok]: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["BarRenderer"].THIN };
        const summarySeriesSet = [...seriesSet].map(s => {
            // It's possible to manually define zones by area-like data series with start/end values for every data point. We don't do that
            // here, but what we do instead is use simplified zones that are defined by a start value and/or an end value. (A missing
            // start or end value indicates an infinite zone.)
            // Those values are then converted into a set of data series in this step.
            ...
            return this.thresholdsService.getBackgrounds(s, zones, summaryScales, this.thresholdsPalette.standardColors, thicknessMap, lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["THRESHOLDS_SUMMARY_RENDERER_CONFIG"]));
        });
        return summarySeriesSet;
    }
};
ThresholdsSummaryExampleComponent.ctorParameters = () => [
    { type: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ThresholdsService"] }
];
ThresholdsSummaryExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    return [
        {
            ...
            name: "Series 1",
            data: [
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:14:29.909Z", format), y: 30 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-27T15:14:29.909Z", format), y: 95 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-29T15:14:29.909Z", format), y: 15 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-31T15:14:29.909Z", format), y: 60 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2017-01-03T15:14:29.909Z", format), y: 35 },
            ],
        },
        {
            id: "series-2",
            name: "Series 2",
            data: [
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:14:29.909Z", format), y: 60 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-27T15:14:29.909Z", format), y: 40 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-29T15:14:29.909Z", format), y: 70 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-31T15:14:29.909Z", format), y: 45 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2017-01-03T15:14:29.909Z", format), y: 90 },
            ],
        },
    ];
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSummaryTestComponent", function() { return ThresholdsSummaryTestComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_summary_test_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-summary-test.component.html */ "39Fa");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nova-ui/charts */ "gKry");
/* harmony import */ var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash/cloneDeep */ "BkRI");
/* harmony import */ var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4__);
...
let ThresholdsSummaryTestComponent = class ThresholdsSummaryTestComponent {
    constructor(thresholdsService) {
        this.thresholdsService = thresholdsService;
        ...
        this.thicknessMap = { "ok": _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["BarRenderer"].THIN };
        this.renderer = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["LineRenderer"]();
    ...
    update(data) {
        const seriesSet = getDataSeriesSet(data, this.accessors, this.startDate).map((d) => (Object.assign(Object.assign({}, d), { renderer: this.renderer, scales: this.scales })));
        const summarySeriesSet = [...seriesSet].map(s => {
            const summaryZoneDefs = [...this.zones, { status: "ok" }];
            const zones = this.thresholdsService.getThresholdZones(s, summaryZoneDefs, this.thresholdsPalette.standardColors);
            this.thresholdsService.injectThresholdsData(s, zones);
            return this.thresholdsService.getBackgrounds(s, zones, this.summaryScales, this.thresholdsPalette.standardColors, this.thicknessMap, lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["THRESHOLDS_SUMMARY_RENDERER_CONFIG"]));
        });
        const thresholdSeriesSet = [];
    ...
    configureGrids(mainChartLeftScaleId) {
        const topGrid = this.chart.getGrid();
...
ThresholdsSummaryTestComponent.ctorParameters = () => [
    { type: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ThresholdsService"] }
];
ThresholdsSummaryTestComponent.propDecorators = {
    data: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
    zones: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }],
    startDate: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Input"] }]
};
ThresholdsSummaryTestComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
...
function getDataSeriesSet(data, accessors, startDate) {
    const toDataPoint = (y, i) => ({ x: startDate.clone().add(i, "d"), y });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSummaryTestHarnessComponent", function() { return ThresholdsSummaryTestHarnessComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_summary_test_harness_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-summary-test-harness.component.html */ "qW1a");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! moment/moment */ "wd/R");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(moment_moment__WEBPACK_IMPORTED_MODULE_3__);
...
let ThresholdsSummaryTestHarnessComponent = class ThresholdsSummaryTestHarnessComponent {
    constructor() {
        this.data = { "series-1": [10, 30, 70, 30, 10], "series-2": [0, 40, 60, 40, 0] };
        this.zones = [
            { status: "error", start: 50 },
            { status: "warning", start: 20, end: 50 },
        ];
...
ThresholdsSummaryTestHarnessComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "nui-thresholds-summary-test-harness",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsBasicExampleComponent", function() { return ThresholdsBasicExampleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_basic_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-basic.example.component.html */ "fdc+");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nova-ui/charts */ "gKry");
...
let ThresholdsBasicExampleComponent = class ThresholdsBasicExampleComponent {
    constructor(thresholdsService) {
        this.thresholdsService = thresholdsService;
    ...
    ngOnInit() {
        ...
        this.chart.getGrid().leftScaleId = scales.y.id;
        // Backgrounds use the StatusBarRenderer which requires a special set of scales.
        // Note that the x scale is shared between the foreground series and the background series.
        // Also note that the y band scale fixes the domain to a single value of STATUS_DOMAIN
        const bgScales = {
...
ThresholdsBasicExampleComponent.ctorParameters = () => [
    { type: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ThresholdsService"] }
];
ThresholdsBasicExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
...
function getData() {
    ...
    return [{
            ...
            name: "Series 1",
            data: [
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:05:00Z", format).toDate(), y: 30 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:10:00Z", format).toDate(), y: 95 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:15:00Z", format).toDate(), y: 15 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:20:00Z", format).toDate(), y: 60 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:25:00Z", format).toDate(), y: 35 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:30:00Z", format).toDate(), y: 5 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:35:00Z", format).toDate(), y: 60 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:40:00Z", format).toDate(), y: 84 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T15:55:00Z", format).toDate(), y: 86 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2016-12-25T16:00:00Z", format).toDate(), y: 35 },
            ],
        }];
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChartDocsThresholdsComponent", function() { return ChartDocsThresholdsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_chart_docs_thresholds_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./chart-docs-thresholds.component.html */ "vIjN");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");



let ChartDocsThresholdsComponent = class ChartDocsThresholdsComponent {
};
ChartDocsThresholdsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "nui-chart-docs-thresholds",
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChartDocsThresholdsModule", function() { return ChartDocsThresholdsModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _chart_docs_thresholds_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./chart-docs-thresholds.component */ "MT3c");
/* harmony import */ var _thresholds_basic_thresholds_basic_example_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./thresholds-basic/thresholds-basic.example.component */ "Ig0H");
/* harmony import */ var _thresholds_spark_thresholds_spark_example_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./thresholds-spark/thresholds-spark.example.component */ "90nt");
/* harmony import */ var _thresholds_summary_thresholds_summary_example_thresholds_summary_example_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./thresholds-summary/thresholds-summary-example/thresholds-summary.example.component */ "BVyO");
/* harmony import */ var _thresholds_summary_thresholds_summary_test_harness_thresholds_summary_test_harness_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./thresholds-summary/thresholds-summary-test-harness/thresholds-summary-test-harness.component */ "HweL");
/* harmony import */ var _thresholds_summary_thresholds_summary_test_thresholds_summary_test_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./thresholds-summary/thresholds-summary-test/thresholds-summary-test.component */ "EYAC");
/* harmony import */ var _thresholds_summary_thresholds_summary_visual_test_thresholds_summary_visual_test_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./thresholds-summary/thresholds-summary-visual-test/thresholds-summary-visual-test.component */ "3EtR");
/* harmony import */ var _thresholds_summary_thresholds_summary_with_interval_scale_test_thresholds_summary_with_interval_scale_test_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./thresholds-summary/thresholds-summary-with-interval-scale-test/thresholds-summary-with-interval-scale-test.component */ "hLjc");
...
let ChartDocsThresholdsModule = class ChartDocsThresholdsModule {
};
ChartDocsThresholdsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _chart_docs_thresholds_component__WEBPACK_IMPORTED_MODULE_7__["ChartDocsThresholdsComponent"],
            _thresholds_basic_thresholds_basic_example_component__WEBPACK_IMPORTED_MODULE_8__["ThresholdsBasicExampleComponent"],
            _thresholds_spark_thresholds_spark_example_component__WEBPACK_IMPORTED_MODULE_9__["ThresholdsSparkExampleComponent"],
            _thresholds_summary_thresholds_summary_example_thresholds_summary_example_component__WEBPACK_IMPORTED_MODULE_10__["ThresholdsSummaryExampleComponent"],
            _thresholds_summary_thresholds_summary_test_thresholds_summary_test_component__WEBPACK_IMPORTED_MODULE_12__["ThresholdsSummaryTestComponent"],
            _thresholds_summary_thresholds_summary_test_harness_thresholds_summary_test_harness_component__WEBPACK_IMPORTED_MODULE_11__["ThresholdsSummaryTestHarnessComponent"],
            _thresholds_summary_thresholds_summary_visual_test_thresholds_summary_visual_test_component__WEBPACK_IMPORTED_MODULE_13__["ThresholdsSummaryVisualTestComponent"],
            _thresholds_summary_thresholds_summary_with_interval_scale_test_thresholds_summary_with_interval_scale_test_component__WEBPACK_IMPORTED_MODULE_14__["ThresholdsSummaryWithIntervalScaleTestComponent"],
        ],
        imports: [
        ...
        providers: [
            { provide: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_4__["DEMO_PATH_TOKEN"], useFactory: () => __webpack_require__("ZHgH") },
        ],
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ThresholdsSummaryWithIntervalScaleTestComponent", function() { return ThresholdsSummaryWithIntervalScaleTestComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_thresholds_summary_with_interval_scale_test_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./thresholds-summary-with-interval-scale-test.component.html */ "ZNpb");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nova-ui/charts */ "gKry");
/* harmony import */ var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lodash/cloneDeep */ "BkRI");
/* harmony import */ var lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4__);
...
let ThresholdsSummaryWithIntervalScaleTestComponent = class ThresholdsSummaryWithIntervalScaleTestComponent {
    constructor(thresholdsService) {
        this.thresholdsService = thresholdsService;
        this.zones = [
            { status: "error", start: 80 },
        ...
        this.summaryZones = [...this.zones, { status: "ok", start: 20, end: 60 }];
    ...
    update() {
        const seriesSet = getData().map((d) => (Object.assign(Object.assign({}, d), { renderer: this.renderer, accessors: this.accessors, scales: this.scales })));
        const summarySeriesSet = [...seriesSet].map(s => {
            const zones = this.thresholdsService.getThresholdZones(s, this.summaryZones, this.thresholdsPalette.standardColors);
            this.thresholdsService.injectThresholdsData(s, zones);
            return this.thresholdsService.getBackgrounds(s, zones, this.summaryScales, this.thresholdsPalette.standardColors, this.thicknessMap, lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_4___default()(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["THRESHOLDS_SUMMARY_RENDERER_CONFIG"]));
...
ThresholdsSummaryWithIntervalScaleTestComponent.ctorParameters = () => [
    { type: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["ThresholdsService"] }
];
ThresholdsSummaryWithIntervalScaleTestComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: "nui-thresholds-summary-with-interval-scale-test",
...
function getData() {
    ...
    return [{
            ...
            name: "Series 1",
            data: [
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:05:00Z", format).toDate(), y: 30 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:10:00Z", format).toDate(), y: 80 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:15:00Z", format).toDate(), y: 80 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:20:00Z", format).toDate(), y: 80 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:25:00Z", format).toDate(), y: 45 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:30:00Z", format).toDate(), y: 60 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:35:00Z", format).toDate(), y: 10 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_5___default()("2016-12-25T15:40:00Z", format).toDate(), y: 35 },
            ],
        }];
}
