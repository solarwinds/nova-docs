...
/* harmony import */ var _spark_chart_area_multiple_spark_chart_area_multiple_example_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./spark-chart-area-multiple/spark-chart-area-multiple.example.component */ "SH0r");
...
ChartDocsSparkModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            ...
            _spark_chart_area_multiple_spark_chart_area_multiple_example_component__WEBPACK_IMPORTED_MODULE_13__["SparkChartAreaMultipleExampleComponent"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SparkChartAreaMultipleExampleComponent", function() { return SparkChartAreaMultipleExampleComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_spark_chart_area_multiple_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./spark-chart-area-multiple.example.component.html */ "/8ED");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let SparkChartAreaMultipleExampleComponent = class SparkChartAreaMultipleExampleComponent {
    ngOnInit() {
        // spark chart setup
        ...
        const accessors = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["stackedAreaAccessors"])(this.chartAssist.palette.standardColors, this.chartAssist.markers);
        // setting the AreaRenderer congif's strokeWidth to zero so no stroke is added around the filled area
        const renderer = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["AreaRenderer"]({ strokeWidth: 0 });
...
SparkChartAreaMultipleExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
...
function getData() {
    ...
    return [
        ...
        },
        {
            ...
            data: [
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-07-08T01:51:43.448Z", format), y: 30 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-07-21T17:35:10.344Z", format), y: 25 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-08-04T09:18:37.241Z", format), y: 84 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-08-18T01:02:04.137Z", format), y: 44 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-08-31T16:45:31.034Z", format), y: 56 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-09-14T08:28:57.931Z", format), y: 70 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-09-28T00:12:24.827Z", format), y: 15 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-10-11T15:55:51.724Z", format), y: 27 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-10-25T07:39:18.620Z", format), y: 85 },
                { x: moment_moment__WEBPACK_IMPORTED_MODULE_4___default()("2018-11-07T23:22:45.517Z", format), y: 30 },
            ],
        },
    ];
}
