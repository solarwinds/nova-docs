(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-demo-advanced-usage-scales-formatters-chart-docs-formatters-module"], {
    ...
    function q9(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "ChartDocsFormattersModule", function () {
        return ChartDocsFormattersModule;
      });
      /* harmony import */
      ...
      var _chart_docs_formatters_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./chart-docs-formatters.component */
      "LuZG");
      /* harmony import */


      var _tick_formatter_tick_formatter_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./tick-formatter/tick-formatter.example.component */
      "RItm");
      ...
      var ChartDocsFormattersModule = function ChartDocsFormattersModule() {
        _classCallCheck(this, ChartDocsFormattersModule);
      };

      ChartDocsFormattersModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_tick_formatter_tick_formatter_example_component__WEBPACK_IMPORTED_MODULE_6__["TickFormatterExampleComponent"], _chart_docs_formatters_component__WEBPACK_IMPORTED_MODULE_5__["ChartDocsFormattersComponent"]],
        ...
        providers: [{
          ...
          useFactory: function useFactory() {
            return __webpack_require__("kDgf");
          }
        }]
    ...
    /***/
    function LuZG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ChartDocsFormattersComponent", function () {
        return ChartDocsFormattersComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_chart_docs_formatters_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./chart-docs-formatters.component.html */
      "WdGD");
      /* harmony import */
      ...
      var ChartDocsFormattersComponent = function ChartDocsFormattersComponent() {
        _classCallCheck(this, ChartDocsFormattersComponent);

        this.customTicks = "scales.x.formatters.tick = (value: Number) => (Number(value).toFixed(2));\nscales.y.formatters.tick = (value: Number) => `> ${value} %`;\n...";
      };

      ChartDocsFormattersComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function RItm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "TickFormatterExampleComponent", function () {
        return TickFormatterExampleComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_tick_formatter_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./tick-formatter.example.component.html */
      "nhCc");
      /* harmony import */
      ...
      var TickFormatterExampleComponent = /*#__PURE__*/function () {
        function TickFormatterExampleComponent() {
          _classCallCheck(this, TickFormatterExampleComponent);
        }

        _createClass(TickFormatterExampleComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            ...
            var grid = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_3__["XYGrid"](); // Set the grid's 'axis.left.fit' property to 'true' to accommodate the extra label width required by the y-scale's tick formatter output.
      ...
      TickFormatterExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
    ...
    /***/
    function kDgf(module, exports, __webpack_require__) {
      var map = {
...
//# sourceMappingURL=components-demo-advanced-usage-scales-formatters-chart-docs-formatters-module-es5.js.map