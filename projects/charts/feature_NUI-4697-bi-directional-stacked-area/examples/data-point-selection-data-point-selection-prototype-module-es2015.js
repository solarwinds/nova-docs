...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataPointSelectionPrototypeComponent", function() { return DataPointSelectionPrototypeComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_data_point_selection_prototype_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./data-point-selection-prototype.component.html */ "IPrL");
/* harmony import */ var _data_point_selection_prototype_component_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data-point-selection-prototype.component.less */ "tgWw");
...
/* harmony import */ var lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash/isEmpty */ "E+oP");
/* harmony import */ var lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var lodash_isUndefined__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! lodash/isUndefined */ "TP7S");
...
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! moment/moment */ "wd/R");
...
let DataPointSelectionPrototypeComponent = class DataPointSelectionPrototypeComponent {
    constructor() {
        ...
        this.colorProvider = {
            ...
            get: (seriesId) => seriesId === "selection-box" ? "transparent" : _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["CHART_PALETTE_CS1"][0],
            reset: () => { },
        };
        this.handleDataPointsInteraction = (event) => {
            ...
            if (data.interactionType === _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].Click) {
                ...
                this.barChart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_VALUES_EVENT"]).next({
                    data: { interactionType: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].MouseMove, values: this.selectedLabelPosition },
                });
            }
        };
        this.handleInteractionLabelUpdates = (event) => {
            const data = event.data;
            // The condition checks whether the mouse has moved away from the chart and a selected label position is stored
            if (data.interactionType === _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].MouseMove && lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(data.values) && this.selectedLabelPosition) {
        ...
        this.handleMouseActive = (event) => {
            if (this.renderer.config.stateStyles) {
                if (!lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(this.selectedDataPoints) && !event.data) {
         ...
         */
        this.selectedDataPointIdxFn = (seriesId) => { var _a, _b, _c; return (_c = (_b = (_a = this.selectedDataPoints) === null || _a === void 0 ? void 0 : _a[seriesId]) === null || _b === void 0 ? void 0 : _b.index) !== null && _c !== void 0 ? _c : _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["DATA_POINT_NOT_FOUND"]; };
        /**
         ...
         */
        this.cssClassAccessor = (d, i, series, dataSeries) => { var _a; return !lodash_isEmpty__WEBPACK_IMPORTED_MODULE_5___default()(this.selectedDataPoints) && dataSeries.id === "selection-box" && ((_a = this.selectedDataPoints[dataSeries.id]) === null || _a === void 0 ? void 0 : _a.index) === i ? "selected" : ""; };
    }
    ngOnInit() {
        this.setUpBarChart();
    ...
    onReset() {
        ...
        this.labelPlugin.areLabelUpdatesEnabled = true;
        this.barChart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_VALUES_EVENT"]).next({ data: { interactionType: _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionType"].MouseMove, values: {} } });
    }
    setUpBarChart() {
        ...
        this.barChart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_DATA_POINTS_EVENT"]).subscribe(this.handleDataPointsInteraction);
        // Setting up interaction label update handling
        this.barChart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["INTERACTION_VALUES_EVENT"]).subscribe(this.handleInteractionLabelUpdates);
        // Setting up what happens on chart mouseenter and mouseleave
        this.barChart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["MOUSE_ACTIVE_EVENT"]).subscribe(this.handleMouseActive);
        // The color provider sets the selection boxes to 'transparent'
        const accessors = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["barAccessors"])({}, this.colorProvider);
        ...
        const scales = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["barScales"])();
        ...
        scales.x = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["TimeIntervalScale"](Object(moment_moment__WEBPACK_IMPORTED_MODULE_7__["duration"])(5, "minutes"), this.xScaleId);
        ...
        this.renderer = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BarRenderer"](rendererConfig);
        // Initialize the bar chart
        this.barChart.update(getData().map(s => (Object.assign(Object.assign({}, s), { accessors, renderer: this.renderer, scales }))));
    }
    setUpStatusChart() {
        this.statusChart = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["Chart"](this.configureStatusGrid());
        this.statusChart.addPlugin(new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["InteractionLinePlugin"]());
        // Setting up the status chart scales
        const statusYScale = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BandScale"]();
        statusYScale.fixDomain(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["StatusAccessors"].STATUS_DOMAIN);
        // Use the same 'x' scale id as the bar chart to ensure that interaction events such as hover are shared between the charts
        const statusXScale = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["TimeIntervalScale"](Object(moment_moment__WEBPACK_IMPORTED_MODULE_7__["duration"])(5, "minutes"), this.xScaleId);
        ...
        const myStatusAccessors = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["statusAccessors"])(new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["MappedValueProvider"](getStatusValueMap()));
        myStatusAccessors.data.thickness = (data) => data.status === Status.Up ? _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BarRenderer"].THIN : _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BarRenderer"].THICK;
        // The 'cssClassAccessor' updates the stroke color of the selection box when a time interval is selected
        ...
        this.statusChart.update(getStatusData()
            .map(d => (Object.assign(Object.assign({}, d), { accessors: myStatusAccessors, renderer: this.renderer, scales: statusScales }))));
    }
    configureBarGrid() {
        const gridConfig = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BarGridConfig"]();
    ...
    configureStatusGrid() {
        const gridConfig = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["BarStatusGridConfig"]();
     ...
     */
    barThickness(scales) {
        return (d, i, series, dataSeries) => {
            var _a, _b, _c, _d;
            let thickness;
            const x1 = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["convert"])(scales.x, (_b = (_a = dataSeries.accessors.data) === null || _a === void 0 ? void 0 : _a["startX"]) === null || _b === void 0 ? void 0 : _b.call(_a, d, i, dataSeries.data, dataSeries), 0);
            const x2 = Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["convert"])(scales.x, (_d = (_c = dataSeries.accessors.data) === null || _c === void 0 ? void 0 : _c["endX"]) === null || _d === void 0 ? void 0 : _d.call(_c, d, i, dataSeries.data, dataSeries), 1);
     ...
     */
    calculateInteractionLabelPosition(data) {
...
DataPointSelectionPrototypeComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    return [
        {
            id: "series-1",
            data: [
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).toDate(), value: 66 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(5, "minutes").toDate(), value: 14 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(10, "minutes").toDate(), value: 25 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(15, "minutes").toDate(), value: 55 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(20, "minutes").toDate(), value: 33 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(25, "minutes").toDate(), value: 5 },
            ],
        },
        ...
        // method in the above component.
        {
            id: "selection-box",
            data: [
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).toDate(), value: 100 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(5, "minutes").toDate(), value: 100 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(10, "minutes").toDate(), value: 100 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(15, "minutes").toDate(), value: 100 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(20, "minutes").toDate(), value: 100 },
                { category: moment_moment__WEBPACK_IMPORTED_MODULE_7___default()(baseDate, format).add(25, "minutes").toDate(), value: 100 },
            ],
        },
    ];
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DataPointSelectionPrototypeModule", function() { return DataPointSelectionPrototypeModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _data_point_selection_prototype_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./data-point-selection-prototype.component */ "25si");
...
let DataPointSelectionPrototypeModule = class DataPointSelectionPrototypeModule {
};
DataPointSelectionPrototypeModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _data_point_selection_prototype_component__WEBPACK_IMPORTED_MODULE_6__["DataPointSelectionPrototypeComponent"],
        ],
        imports: [
        ...
        providers: [
            { provide: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["DEMO_PATH_TOKEN"], useFactory: () => __webpack_require__("YAGT") },
        ],
    })
...
//# sourceMappingURL=data-point-selection-data-point-selection-prototype-module-es2015.js.map