...
/* harmony import */ var _raw_loader_time_frame_bar_basic_example_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./time-frame-bar-basic.example.component.html */ "EUdT");
...
let TimeFrameBarBasicExampleComponent = class TimeFrameBarBasicExampleComponent {
    constructor(history, dataSourceService) {
    ...
    ngOnInit() {
        const accessors = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["LineAccessors"](this.chartAssist.palette.standardColors, this.chartAssist.markers);
        ...
        this.seriesSet = Object.keys(this.series).map((key) => ({
            id: key,
            name: key,
        ...
        this.chart.getEventBus().getStream(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["SET_DOMAIN_EVENT"]).subscribe((event) => {
...
TimeFrameBarBasicExampleComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["HistoryStorage"],
        _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NoopDataSourceService"]])
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChartDocsTimeFrameBarModule", function() { return ChartDocsTimeFrameBarModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
...
/* harmony import */ var _chart_docs_time_frame_bar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./chart-docs-time-frame-bar.component */ "jNox");
/* harmony import */ var _time_frame_bar_basic_time_frame_bar_basic_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./time-frame-bar-basic/time-frame-bar-basic.example.component */ "47r6");
/* harmony import */ var _time_frame_bar_test_time_frame_bar_test_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./time-frame-bar-test/time-frame-bar-test.component */ "VnDG");
...
let ChartDocsTimeFrameBarModule = class ChartDocsTimeFrameBarModule {
};
ChartDocsTimeFrameBarModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _chart_docs_time_frame_bar_component__WEBPACK_IMPORTED_MODULE_6__["ChartDocsTimeFrameBarComponent"],
            _time_frame_bar_basic_time_frame_bar_basic_example_component__WEBPACK_IMPORTED_MODULE_7__["TimeFrameBarBasicExampleComponent"],
            _time_frame_bar_test_time_frame_bar_test_component__WEBPACK_IMPORTED_MODULE_8__["TimeFrameBarTestComponent"],
        ],
        imports: [
            ...
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiBusyModule"],
            ...
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiLayoutModule"],
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiPopoverModule"],
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiTimeFramePickerModule"],
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiTimeFrameBarModule"],
            _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiTooltipModule"],
            _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(exampleRoutes),
        ],
        providers: [
            { provide: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["DEMO_PATH_TOKEN"], useFactory: () => __webpack_require__("Xc7/") },
        ],
    })
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_time_frame_bar_test_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./time-frame-bar-test.component.html */ "oS9I");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nova-ui/bits */ "Rr1A");
/* harmony import */ var _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nova-ui/charts */ "gKry");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! moment/moment */ "wd/R");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(moment_moment__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _time_frame_bar_data_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./time-frame-bar-data.service */ "fePE");
...
let TimeFrameBarTestComponent = class TimeFrameBarTestComponent {
    constructor(history, dataSourceService) {
        this.history = history;
        this.dataSourceService = dataSourceService;
    ...
    setUpFiltering() {
        ...
        return this.dataSourceService.outputsSubject.subscribe((data) => {
            ...
            this.dataService.getChartData(start, end, this.addDelay ? 1000 : 0).subscribe((series) => {
                this.chartAssist.update(Object.keys(series).map((key) => ({
                    id: key,
                    name: key,
                    data: series[key],
...
TimeFrameBarTestComponent.ctorParameters = () => [
    { type: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["HistoryStorage"] },
    { type: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NoopDataSourceService"] }
];
TimeFrameBarTestComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarDataService", function() { return TimeFrameBarDataService; });
...
(function (DataInterval) {
    ...
    DataInterval[DataInterval["Hour"] = 60] = "Hour";
    // Day = 24 * 60,
    // Week = 7 * 24 * 60,
})(DataInterval || (DataInterval = {}));
class TimeFrameBarDataService {
    constructor() {
        // tslint:disable:max-line-length
        this.factors = {
            "day": [42, 7, 63, 33, 10, 16, 57, 16, 88, 44, 35, 85, 46, 73, 29, 35, 51, 52, 100, 51, 40, 87, 42, 90, 75, 90, 70, 16, 4, 43, 18, 63, 28, 15, 86, 81, 48, 86, 91, 89, 15, 89, 66, 35, 65, 18, 59, 75, 69, 64, 55, 67, 60, 76, 29, 81, 87, 73, 10, 19, 29, 83, 16, 72, 80, 43, 28, 53, 38, 24, 88, 81, 14, 68, 80, 44, 72, 56, 89, 83, 6, 1, 1, 11, 66, 39, 42, 81, 31, 48, 11, 76, 41, 60, 40, 15, 75, 33, 90, 80, 37, 40, 39, 58, 69, 31, 61, 80, 85, 57, 38, 3, 45, 36, 71, 66, 36, 58, 82, 70, 90, 78, 33, 72, 98, 36, 32, 61, 44, 13, 22, 90, 66, 87, 55, 21, 63, 70, 41, 61, 19, 42, 65, 79, 17, 14, 85, 69, 79, 77, 99, 86, 5, 31, 94, 2, 37, 54, 79, 32, 63, 83, 64, 52, 59, 35, 18, 45, 58, 23, 58, 99, 61, 60, 78, 95, 63, 35, 27, 93, 46, 86, 51, 80, 73, 6, 66, 72, 96, 7, 90, 94, 3, 66, 1, 38, 30, 11, 58, 91, 84, 100, 90, 70, 51, 77, 56, 53, 49, 42, 84, 10, 76, 11, 66, 41, 38, 68, 24, 84, 89, 72, 74, 54, 29, 18, 36, 13, 17, 18, 82, 14, 50, 10, 47, 12, 1, 4, 63, 59, 62, 78, 83, 5, 25, 8, 59, 59, 28, 56, 35, 33, 31, 37, 5, 67, 34, 93, 25, 66, 69, 64, 23, 69, 60, 24, 26, 81, 88, 66, 80, 45, 91, 68, 83, 8, 83, 43, 96, 85, 8, 47, 67, 14, 64, 26, 96, 45],
    ...
    getChartData(from, to, delayInterval = 0) {
        const rules = this.seriesValueFunctions;
        const results = {};
        const duration = moment_moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(to.diff(from));
        const dataInterval = duration.asHours() > 12 ? DataInterval.Hour : DataInterval.Poll;
        for (const seriesId of Object.keys(rules)) {
            results[seriesId] = this.getData(from, to, rules[seriesId], dataInterval);
        }
    ...
    getData(start, end, valueFn, interval = DataInterval.Poll) {
        const startCorrector = start.minutes() % interval;
        const currentDate = start.clone().subtract(startCorrector, "minutes").seconds(0); // rounds to pollInterval
        const endCorrector = interval - end.minutes() % interval;
        const endDate = end.clone().add(endCorrector, "minutes").seconds(0); // rounds to 5 minutes pollInterval
        const count = Math.ceil(moment_moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(endDate.diff(currentDate)).asMinutes() / interval);
        const results = [];
        for (let i = 0; i < count; i++) {
            const fDay = this.factors.day[Math.ceil((60 * currentDate.hours() + currentDate.minutes()) / 5)];
            const fYear = this.factors.year[currentDate.dayOfYear()];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChartDocsTimeFrameBarComponent", function() { return ChartDocsTimeFrameBarComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_chart_docs_time_frame_bar_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./chart-docs-time-frame-bar.component.html */ "dsON");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");



let ChartDocsTimeFrameBarComponent = class ChartDocsTimeFrameBarComponent {
};
ChartDocsTimeFrameBarComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
