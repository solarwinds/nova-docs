(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pie-chart-pie-chart-example-module"], {
    ...
    /***/
    function hsLt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PieChartExampleModule", function () {
        return PieChartExampleModule;
      });
      /* harmony import */
      ...
      var _pie_chart_test_pie_chart_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./pie-chart-test/pie-chart.example.component */
      "ueFZ");
      ...
      var PieChartExampleModule = function PieChartExampleModule() {
        _classCallCheck(this, PieChartExampleModule);
      };

      PieChartExampleModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_pie_chart_test_pie_chart_example_component__WEBPACK_IMPORTED_MODULE_6__["PieChartTestComponent"]],
        imports: [_common_demo_common_module__WEBPACK_IMPORTED_MODULE_5__["DemoCommonModule"], _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["NuiChartsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiButtonModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiCheckboxModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiTextboxModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(bubbleRoutes), _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiExpanderModule"]]
    ...
    /***/
    function ueFZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PieChartTestComponent = /*#__PURE__*/function () {
        function PieChartTestComponent(toastr) {
          var _this = this;
          ...
          this.processSeries = function (chartSeriesSet) {
            return Object(_nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["radialPreprocessor"])(chartSeriesSet, function (series) {
              return !_this.chartAssist.isSeriesHidden(series.id);
            });
          };
        }
        ...
        _createClass(PieChartTestComponent, [{
          ...
          value: function ngOnInit() {
            ...
            var gridConfig = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["GridConfig"]();
            ...
            this.refreshPie();
            this.chart.getEventBus().getStream("click").subscribe(function (event) {
              _this2.toastr.info({
                title: "Event Published",
                message: "event: click; data: ".concat(event.data),
                options: {
                  timeOut: 1500
                }
              });
          ...
          key: "generateSeriesSet",
          value: function generateSeriesSet() {
            var _this3 = this;

            var layers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1;

            var donutSeriesSet = _data_generator__WEBPACK_IMPORTED_MODULE_5__["DataGenerator"].generateMockOrdinalSeriesSet(["Chrome", "Firefox", "Edge"], layers);

            donutSeriesSet.forEach(function (s) {
              s.id += "-".concat(Math.round(Math.random() * 100));
            });
            return donutSeriesSet.map(function (dataSeries) {
              return Object.assign(Object.assign({}, dataSeries), {
                accessors: {
                  ...
                  series: {
                    color: _this3.chartAssist.palette.standardColors.get
                  }
                },
          ...
          key: "updatemaxWidth",
          value: function updatemaxWidth(value) {
            this.renderer.config.maxThickness = value;
            this.updateDonut();
          }
        }, {
          key: "refreshPieInteraction",
          value: function refreshPieInteraction() {
          ...
          key: "refreshDonut",
          value: function refreshDonut(layers) {
            var _this4 = this;

            this.renderer = new _nova_ui_charts__WEBPACK_IMPORTED_MODULE_4__["RadialRenderer"](); // Hack for demo page, since it loads pie first and we can switch between chart renderers

            this.chartAssist.update(this.generateSeriesSet(layers));
            setTimeout(function () {
              _this4.chart.updateDimensions();
            }, 0);
          }
        }, {
          key: "showContent",
          ...
          key: "updateDonut",
          value: function updateDonut() {
            var _this5 = this;

            setTimeout(function () {
              _this5.chart.updateDimensions();
            }, 0);
          }
        }]);
      ...
      PieChartTestComponent.ctorParameters = function () {
        return [{
          type: undefined,
          decorators: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["Inject"],
            args: [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["ToastService"]]
          }]
        }];
      };
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [Object])], PieChartTestComponent);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pie-chart-pie-chart-example-module-es5.js.map