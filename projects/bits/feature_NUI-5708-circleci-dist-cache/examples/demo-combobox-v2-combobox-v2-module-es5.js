        ...
        _createClass(ComboboxV2VirtualScrollExampleComponent, [{
          ...
          value: function handleClick() {
            if (this.viewport) {
              ...
              this.viewport.checkViewportSize(); // this.viewport.scrollToIndex(this.combobox.selectedOption?.index);
            }
          }
        }, {
          key: "ngAfterViewInit",
