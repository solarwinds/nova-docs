(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-date-time-picker-date-time-picker-module"], {
    ...
    function fvUN(module, __webpack_exports__, __webpack_require__) {
      ...
      DateTimePickerEmptyStateComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({
        ...
        template: function DateTimePickerEmptyStateComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("modelChanged", function DateTimePickerEmptyStateComponent_Template_nui_date_time_picker_modelChanged_2_listener($event) {
              return ctx.onModelChanged($event);
            });
