(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-selector-selector-module"], {
    ...
    /***/
    function sVD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function aWm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function J7Rg(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LcQ8(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectorModule", function () {
      ...
      var _selector_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var SelectorModule = function SelectorModule() {
      ...
      SelectorModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({
        providers: [{
          ...
          useFactory: function useFactory() {
            return __webpack_require__("jhUJ");
          }
        }],
        imports: [[_nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiSelectorModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiDocsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](SelectorModule, {
          declarations: [_selector_example_component__WEBPACK_IMPORTED_MODULE_2__["SelectorExampleComponent"]],
          imports: [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiSelectorModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiDocsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]],
    ...
    /***/
    function aBW7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectorExampleComponent", function () {
        return SelectorExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_selector_selector_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../../../../../src/lib/selector/selector.component */
      "E+Rb");

      var SelectorExampleComponent = /*#__PURE__*/function () {
        function SelectorExampleComponent() {
          _classCallCheck(this, SelectorExampleComponent);
        ...
        _createClass(SelectorExampleComponent, [{
          ...
          key: "makeIndeterminate",
          value: function makeIndeterminate() {
            this.checkBoxStatus = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["CheckboxStatus"].Indeterminate;
            this.selection = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["SelectionType"].SomePages;
          }
        }, {
          key: "makeAppendedToBody",
          value: function makeAppendedToBody() {
            this.appendToBody = true;
          }
        }, {
          key: "getMenuItems",
          value: function getMenuItems(arr) {
            var resultArr = [{
              itemsSource: []
            }];
            arr.map(function (element) {
              resultArr[0].itemsSource.push({
                value: element,
                title: element
              });
            });
      ...
      SelectorExampleComponent.ɵfac = function SelectorExampleComponent_Factory(t) {
        return new (t || SelectorExampleComponent)();
      };

      SelectorExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectorExampleComponent,
        selectors: [["nui-selector-example"]],
        decls: 15,
        vars: 5,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_2810888944812898030$$DEMO_SRC_COMPONENTS_DEMO_SELECTOR_SELECTOR_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Make indeterminate");
            i18n_0 = MSG_EXTERNAL_2810888944812898030$$DEMO_SRC_COMPONENTS_DEMO_SELECTOR_SELECTOR_EXAMPLE_COMPONENT_TS_1;
          } else {
            i18n_0 = $localize(_templateObject || (_templateObject = _taggedTemplateLiteral([":\u241F13aebccf3b7526151f9efc0c9423822f269e0ad2\u241F2810888944812898030:Make indeterminate"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3335553063699247815$$DEMO_SRC_COMPONENTS_DEMO_SELECTOR_SELECTOR_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Make appended to body");
            i18n_2 = MSG_EXTERNAL_3335553063699247815$$DEMO_SRC_COMPONENTS_DEMO_SELECTOR_SELECTOR_EXAMPLE_COMPONENT_TS_3;
          } else {
            i18n_2 = $localize(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([":\u241Fd1a539e5756ea095398f07ee483e430a593d6c58\u241F3335553063699247815:Make appended to body"])));
          }

          return [["id", "nui-demo-selector", 3, "checkboxStatus", "appendToBody", "items", "selectionChange"], ["href", "javascript:;", "id", "nui-demo-make-indeterminate", 3, "click"], i18n_0, ["href", "javascript:;", "id", "nui-demo-make-appended-to-body", 3, "click"], i18n_2, ["id", "nui-demo-selection-type"], ["id", "nui-demo-indeterminate"]];
        },
        template: function SelectorExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("selectionChange", function SelectorExampleComponent_Template_nui_selector_selectionChange_2_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectorExampleComponent_Template_a_click_3_listener() {
              return ctx.makeIndeterminate();
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectorExampleComponent_Template_a_click_5_listener() {
              return ctx.makeAppendedToBody();
            });
        ...
        directives: [_src_lib_selector_selector_component__WEBPACK_IMPORTED_MODULE_2__["SelectorComponent"]],
        encapsulation: 2
      });
      /***/
    },
    ...
    /***/
    function jhUJ(module, exports, __webpack_require__) {
      var map = {
...
//# sourceMappingURL=demo-selector-selector-module-es5.js.map