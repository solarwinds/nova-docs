...
/* harmony import */ var _highlight_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./highlight.example.component */ "RFgQ");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HighlightExampleComponent", function() { return HighlightExampleComponent; });
...
function HighlightExampleComponent_p_3_Template(rf, ctx) { if (rf & 1) {
...
function HighlightExampleComponent_p_14_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "p", 4);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](1, "nuiHighlight");
} if (rf & 2) {
...
HighlightExampleComponent.ɵfac = function HighlightExampleComponent_Factory(t) { return new (t || HighlightExampleComponent)(); };
HighlightExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HighlightExampleComponent, selectors: [["nui-highlight"]], decls: 25, vars: 12, consts: function () { let i18n_0; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_3166421379558502876$$DEMO_SRC_COMPONENTS_DEMO_HIGHLIGHT_HIGHLIGHT_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Search Term:");
        i18n_0 = MSG_EXTERNAL_3166421379558502876$$DEMO_SRC_COMPONENTS_DEMO_HIGHLIGHT_HIGHLIGHT_EXAMPLE_COMPONENT_TS_1;
    }
    else {
        i18n_0 = $localize `:␟220f75007b39241cb07366aa68b51ffb7d2731f6␟3166421379558502876:Search Term:`;
    } let i18n_2; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_7534204636174334747$$DEMO_SRC_COMPONENTS_DEMO_HIGHLIGHT_HIGHLIGHT_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Text below is piped via filter as well. But highlight doesn't appear. {$lineBreak} Class {$startItalicText}nui-ignore-highlight{$closeItalicText} on container prevents it.", { "lineBreak": "\uFFFD#21\uFFFD\uFFFD/#21\uFFFD", "startItalicText": "\uFFFD#22\uFFFD", "closeItalicText": "\uFFFD/#22\uFFFD" });
        i18n_2 = MSG_EXTERNAL_7534204636174334747$$DEMO_SRC_COMPONENTS_DEMO_HIGHLIGHT_HIGHLIGHT_EXAMPLE_COMPONENT_TS_3;
    }
    else {
        i18n_2 = $localize `:␟b57a521a851d0412859b0c99ff6bc14d39092980␟7534204636174334747:Text below is piped via filter as well. But highlight doesn't appear. ${"\uFFFD#21\uFFFD\uFFFD/#21\uFFFD"}:LINE_BREAK: Class ${"\uFFFD#22\uFFFD"}:START_ITALIC_TEXT:nui-ignore-highlight${"\uFFFD/#22\uFFFD"}:CLOSE_ITALIC_TEXT: on container prevents it.`;
    } return [[3, "innerHTML", 4, "ngFor", "ngForOf"], ["for", "search"], i18n_0, ["id", "search", 3, "ngModel", "ngModelChange"], [3, "innerHTML"], [1, "nui-ignore-highlight"], [1, "nui-text-label"], i18n_2]; }, template: function HighlightExampleComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function HighlightExampleComponent_Template_input_ngModelChange_10_listener($event) { return ctx.search = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
//# sourceMappingURL=demo-highlight-highlight-module-es2015.js.map