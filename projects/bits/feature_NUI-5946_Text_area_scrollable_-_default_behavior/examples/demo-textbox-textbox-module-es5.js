  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-textbox-textbox-module"], {
    ...
    function FXCL(module, __webpack_exports__, __webpack_require__) {
      ...
      TextboxVisualTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        consts: function consts() {
          ...
          return [[1, "container"], [1, "row"], [1, "col"], ["id", "nui-visual-test-textbox-item", "value", "example value"], ["id", "nui-visual-test-placeholder-textbox-item", "placeholder", i18n_0], [1, "w-100"], ["id", "nui-visual-test-disabled-textbox-item", "value", "disabled textbox", "disabled", "true"], ["id", "nui-visual-test-readonly-textbox-item", "value", "readonly textbox", "readonly", "true"], ["id", "nui-visual-test-required-textbox-item", 3, "value", "isInErrorState", "textChange"], ["id", "nui-visual-test-custom-width-textbox-item", "customBoxWidth", "200px"], ["caption", i18n_2, "hint", i18n_4], ["id", "nui-visual-test-hint-textbox-item"], ["caption", i18n_6, "info", i18n_8, "id", "nui-visual-test-info-formfield-item"], ["id", "nui-visual-test-info-textbox-item", "value", "Textbox with info"], ["id", "nui-visual-test-area-textbox-item", "value", "Text area", "rows", "5"], ["id", "nui-visual-test-placeholder-area-textbox-item", "rows", "5", "placeholder", i18n_10], ["id", "nui-visual-test-area-scrollable-textbox-item", "rows", "5", 3, "value"], ["id", "nui-visual-test-area-non-scrollable-textbox-item", "rows", "5", 3, "value", "isScrollable"]];
        },
    ...
    function zPrR(module, __webpack_exports__, __webpack_require__) {
      ...
      TextboxAreaExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 4,
        vars: 2,
        consts: [[1, "d-flex"], [1, "pb-3", 3, "value", "valueChange"], ["id", "demo-options-area-textbox-item", "value", "Text area", "rows", "5", 3, "isScrollable"]],
        template: function TextboxAreaExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function TextboxAreaExampleComponent_Template_nui_switch_valueChange_1_listener($event) {
              return ctx.scrollable = $event;
            });
        ...
        directives: [_src_lib_switch_switch_component__WEBPACK_IMPORTED_MODULE_1__["SwitchComponent"], _src_lib_textbox_textbox_component__WEBPACK_IMPORTED_MODULE_2__["TextboxComponent"]],
        encapsulation: 2
      });
      /***/
    }
