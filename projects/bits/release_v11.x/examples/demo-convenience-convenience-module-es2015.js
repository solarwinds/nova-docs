...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConvenienceModule", function() { return ConvenienceModule; });
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nova-ui/bits */ "b5Xb");
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index */ "w5o8");
...
const routes = [
    ...
    {
        path: "time-frame-bar",
        loadChildren: () => __webpack_require__.e(/*! import() | time-frame-bar-time-frame-bar-module */ "time-frame-bar-time-frame-bar-module").then(__webpack_require__.bind(null, /*! ./time-frame-bar/time-frame-bar.module */ "dOrA")).then(m => m.TimeFrameBarModule),
    },
];
class ConvenienceModule {
}
ConvenienceModule.ɵfac = function ConvenienceModule_Factory(t) { return new (t || ConvenienceModule)(); };
ConvenienceModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineNgModule"]({ type: ConvenienceModule });
ConvenienceModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ imports: [[
            _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"].forChild(routes),
        ], _angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](ConvenienceModule, { declarations: [_index__WEBPACK_IMPORTED_MODULE_2__["SummaryComponent"]], imports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]], exports: [_angular_router__WEBPACK_IMPORTED_MODULE_0__["RouterModule"]] }); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarTestComponent", function() { return TimeFrameBarTestComponent; });
...
/* harmony import */ var _src_lib_convenience_time_frame_bar_time_frame_bar_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../../src/lib/convenience/time-frame-bar/time-frame-bar.component */ "SKIm");
...
/* harmony import */ var _src_lib_time_frame_picker_time_frame_format_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../../../../../src/lib/time-frame-picker/time-frame-format.pipe */ "Y/g/");
...
class TimeFrameBarTestComponent {
    constructor(history) {
...
TimeFrameBarTestComponent.ɵfac = function TimeFrameBarTestComponent_Factory(t) { return new (t || TimeFrameBarTestComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["HistoryStorage"])); };
TimeFrameBarTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: TimeFrameBarTestComponent, selectors: [["nui-convenience-time-frame-bar-test"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵProvidersFeature"]([_nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["HistoryStorage"]])], decls: 11, vars: 7, consts: [[1, "nui-time-frame-bar-test"], [3, "minDate", "maxDate", "timeFrame", "historyIndex", "timeFrameChange", "undo", "clear"], ["icon", "calendar", 1, "pr-3"], ["timeFrameSelection", ""], [1, "btn-zoom-in", 3, "click"], [1, "btn-set-default", 3, "click"]], template: function TimeFrameBarTestComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](1, "nui-time-frame-bar", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("timeFrameChange", function TimeFrameBarTestComponent_Template_nui_time_frame_bar_timeFrameChange_1_listener($event) { return ctx.onChange($event); })("undo", function TimeFrameBarTestComponent_Template_nui_time_frame_bar_undo_1_listener() { return ctx.timeFrame = ctx.history.undo(); })("clear", function TimeFrameBarTestComponent_Template_nui_time_frame_bar_clear_1_listener() { return ctx.onChange(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function TimeFrameBarTestComponent_Template_button_click_7_listener() { return ctx.zoomIn(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function TimeFrameBarTestComponent_Template_button_click_9_listener() { return ctx.resetDefault(); });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarBasicExampleComponent", function() { return TimeFrameBarBasicExampleComponent; });
...
/* harmony import */ var _src_lib_convenience_time_frame_bar_time_frame_bar_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../../src/lib/convenience/time-frame-bar/time-frame-bar.component */ "SKIm");
...
/* harmony import */ var _src_lib_time_frame_picker_time_frame_format_pipe__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../../../../../src/lib/time-frame-picker/time-frame-format.pipe */ "Y/g/");
...
class TimeFrameBarBasicExampleComponent {
    constructor() {
...
TimeFrameBarBasicExampleComponent.ɵfac = function TimeFrameBarBasicExampleComponent_Factory(t) { return new (t || TimeFrameBarBasicExampleComponent)(); };
TimeFrameBarBasicExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: TimeFrameBarBasicExampleComponent, selectors: [["nui-convenience-time-frame-bar-basic-example"]], decls: 9, vars: 9, consts: [[3, "minDate", "maxDate", "timeFrame", "timeFrameChange"], ["icon", "calendar", 1, "pr-3"], ["timeFrameSelection", ""]], template: function TimeFrameBarBasicExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-time-frame-bar", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("timeFrameChange", function TimeFrameBarBasicExampleComponent_Template_nui_time_frame_bar_timeFrameChange_0_listener($event) { return ctx.timeFrame = $event; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarZoomExampleComponent", function() { return TimeFrameBarZoomExampleComponent; });
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nova-ui/bits */ "b5Xb");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! moment/moment */ "wd/R");
/* harmony import */ var moment_moment__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(moment_moment__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
class TimeFrameBarZoomExampleComponent {
    // Inject an instance of HistoryStorage
    constructor(history) {
        this.history = history;
        this.baseDate = moment_moment__WEBPACK_IMPORTED_MODULE_1___default()([2018, 5, 1, 15, 0, 0]);
        this.zoomLevels = ["weeks", "days", "hours", "minutes"];
        // Save the new timeframe to the history storage and set it as the current timeFrame
        this.onZoomIn = () => this.timeFrame = this.history.save(this.getTimeFrame(this.zoomLevels[this.history.index + 1]));
        // Use the history storage to go back one time frame
        this.onUndo = () => this.timeFrame = this.history.undo();
        // Reset the history storage and save a new initial value if provided
        // Otherwise preserve the previous one
        this.onChange = (value) => this.timeFrame = this.history.restart(value);
    }
    ngOnInit() {
...
TimeFrameBarZoomExampleComponent.ɵfac = function TimeFrameBarZoomExampleComponent_Factory(t) { return new (t || TimeFrameBarZoomExampleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdirectiveInject"](_nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["HistoryStorage"])); };
TimeFrameBarZoomExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: TimeFrameBarZoomExampleComponent, selectors: [["nui-convenience-time-frame-bar-zoom-example"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵProvidersFeature"]([_nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["HistoryStorage"]])], decls: 11, vars: 11, consts: [[3, "minDate", "maxDate", "timeFrame", "historyIndex", "timeFrameChange", "undo", "clear"], ["icon", "calendar", 1, "pr-3"], ["timeFrameSelection", ""], ["nui-button", "", "type", "button", "icon", "zoom-in", "displayStyle", "primary", 3, "disabled", "click"]], template: function TimeFrameBarZoomExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "nui-time-frame-bar", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("timeFrameChange", function TimeFrameBarZoomExampleComponent_Template_nui_time_frame_bar_timeFrameChange_0_listener($event) { return ctx.onChange($event); })("undo", function TimeFrameBarZoomExampleComponent_Template_nui_time_frame_bar_undo_0_listener() { return ctx.onUndo(); })("clear", function TimeFrameBarZoomExampleComponent_Template_nui_time_frame_bar_clear_0_listener() { return ctx.onChange(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("click", function TimeFrameBarZoomExampleComponent_Template_button_click_9_listener() { return ctx.onZoomIn(); });
    ...
    } }, directives: [_src_lib_convenience_time_frame_bar_time_frame_bar_component__WEBPACK_IMPORTED_MODULE_3__["TimeFrameBarComponent"], _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_4__["IconComponent"], _src_lib_time_frame_picker_quick_picker_quick_picker_component__WEBPACK_IMPORTED_MODULE_5__["QuickPickerComponent"], _src_lib_time_frame_picker_time_frame_picker_component__WEBPACK_IMPORTED_MODULE_6__["TimeFramePickerComponent"], _src_lib_button_button_component__WEBPACK_IMPORTED_MODULE_7__["ButtonComponent"]], pipes: [_src_lib_time_frame_picker_time_frame_format_pipe__WEBPACK_IMPORTED_MODULE_8__["TimeFrameFormatPipe"], _angular_common__WEBPACK_IMPORTED_MODULE_9__["JsonPipe"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarDocsExampleComponent", function() { return TimeFrameBarDocsExampleComponent; });
...
/* harmony import */ var _time_frame_bar_basic_time_frame_bar_basic_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../time-frame-bar-basic/time-frame-bar-basic.example.component */ "c3yb");
/* harmony import */ var _time_frame_bar_zoom_time_frame_bar_zoom_example_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../time-frame-bar-zoom/time-frame-bar-zoom.example.component */ "fWKI");





class TimeFrameBarDocsExampleComponent {
}
TimeFrameBarDocsExampleComponent.ɵfac = function TimeFrameBarDocsExampleComponent_Factory(t) { return new (t || TimeFrameBarDocsExampleComponent)(); };
TimeFrameBarDocsExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TimeFrameBarDocsExampleComponent, selectors: [["nui-time-frame-bar-docs-example"]], decls: 108, vars: 1, consts: [["href", "../components/TimeFrameBarComponent.html", "target", "_blank"], ["href", "../additional-documentation/convenience-components.html", "target", "_parent"], ["href", "../components/TimeFramePickerComponent.html", "target", "_blank"], ["href", "../components/QuickPickerComponent.html", "target", "_blank"], ["type", "warning", 3, "allowDismiss"], ["filenamePrefix", "time-frame-bar-basic", "exampleTitle", "Basic Usage"], ["filenamePrefix", "time-frame-bar-zoom", "exampleTitle", "Adding Zoom Functionality"], ["href", "../injectables/HistoryStorage.html", "target", "_blank"]], template: function TimeFrameBarDocsExampleComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _summary_summary_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./summary/summary.component */ "yxz5");
...
/* harmony import */ var _time_frame_bar_time_frame_bar_basic_time_frame_bar_basic_example_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./time-frame-bar/time-frame-bar-basic/time-frame-bar-basic.example.component */ "c3yb");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarBasicExampleComponent", function() { return _time_frame_bar_time_frame_bar_basic_time_frame_bar_basic_example_component__WEBPACK_IMPORTED_MODULE_1__["TimeFrameBarBasicExampleComponent"]; });

/* harmony import */ var _time_frame_bar_time_frame_bar_zoom_time_frame_bar_zoom_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./time-frame-bar/time-frame-bar-zoom/time-frame-bar-zoom.example.component */ "fWKI");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarZoomExampleComponent", function() { return _time_frame_bar_time_frame_bar_zoom_time_frame_bar_zoom_example_component__WEBPACK_IMPORTED_MODULE_2__["TimeFrameBarZoomExampleComponent"]; });

/* harmony import */ var _time_frame_bar_time_frame_bar_docs_time_frame_bar_docs_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./time-frame-bar/time-frame-bar-docs/time-frame-bar-docs.example.component */ "vrpX");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarDocsExampleComponent", function() { return _time_frame_bar_time_frame_bar_docs_time_frame_bar_docs_example_component__WEBPACK_IMPORTED_MODULE_3__["TimeFrameBarDocsExampleComponent"]; });

/* harmony import */ var _time_frame_bar_time_frame_bar_test_time_frame_bar_test_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./time-frame-bar/time-frame-bar-test/time-frame-bar-test.component */ "Zfd4");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TimeFrameBarTestComponent", function() { return _time_frame_bar_time_frame_bar_test_time_frame_bar_test_component__WEBPACK_IMPORTED_MODULE_4__["TimeFrameBarTestComponent"]; });
...
SummaryComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SummaryComponent, selectors: [["nui-convenience-summary"]], decls: 22, vars: 0, consts: [["type", "a"]], template: function SummaryComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "h1");
...
//# sourceMappingURL=demo-convenience-convenience-module-es2015.js.map