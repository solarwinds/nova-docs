        ...
        _createClass(WizardDialogExampleComponent, [{
          ...
          value: function finishWizard() {
            this.toastService.success({
              ...
              message: $localize(_templateObject150 || (_templateObject150 = _taggedTemplateLiteral(["Wizard was completed successfully"]))),
              options: {
                timeOut: 2000
              }
            });
        ...
        _createClass(WizardAsyncFormValidationExampleComponent, [{
          ...
          value: function finishWizard() {
            this.toastService.success({
              ...
              message: $localize(_templateObject161 || (_templateObject161 = _taggedTemplateLiteral(["Wizard was completed successfully"]))),
              options: {
                timeOut: 2000
              }
            });
