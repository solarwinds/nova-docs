(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["demo-select-v2-select-v2-module"], {
    ...
    function Hvy(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ErrorExampleComponent", function () {
        return SelectV2ErrorExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      ...
      var _src_lib_switch_switch_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      function SelectV2ErrorExampleComponent_ng_container_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2ErrorExampleComponent = function SelectV2ErrorExampleComponent() {
        _classCallCheck(this, SelectV2ErrorExampleComponent);
      ...
      SelectV2ErrorExampleComponent.ɵfac = function SelectV2ErrorExampleComponent_Factory(t) {
        return new (t || SelectV2ErrorExampleComponent)();
      };

      SelectV2ErrorExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2ErrorExampleComponent,
        selectors: [["nui-select-v2-error-example"]],
        hostAttrs: [1, "select-container"],
        decls: 4,
        vars: 3,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_ERROR_SELECT_V2_ERROR_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_6222469594242551638$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_ERROR_SELECT_V2_ERROR_EXAMPLE_COMPONENT_TS_3 = goog.getMsg(" Toggle error state\n");
            ...
            i18n_2 = $localize(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral([":\u241F8be663d50519e814efd0a41e9f01c07ed108c259\u241F6222469594242551638: Toggle error state\n"])));
          }

          return [["placeholder", i18n_0, 1, "w-50", "d-inline-flex", 3, "isInErrorState"], [4, "ngFor", "ngForOf"], [1, "d-inline-flex", 2, "padding-left", "15px", 3, "value", "valueChange"], i18n_2, [3, "value"]];
        },
        template: function SelectV2ErrorExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function SelectV2ErrorExampleComponent_Template_nui_switch_valueChange_2_listener($event) {
    ...
    /***/
    function ZZw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ColorPickerComponent", function () {
        return SelectV2ColorPickerComponent;
      });
      /* harmony import */
      ...
      function SelectV2ColorPickerComponent_div_2_div_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2ColorPickerComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2ColorPickerComponent_ng_template_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var CHART_PALETTE_CS1 = ["var(--nui-color-bg-secondary)", "var(--nui-color-chart-one)", "var(--nui-color-chart-two)", "var(--nui-color-chart-three)", "var(--nui-color-chart-four)", "var(--nui-color-chart-five)", "var(--nui-color-chart-six)", "var(--nui-color-chart-seven)", "var(--nui-color-chart-eight)", "var(--nui-color-chart-nine)", "var(--nui-color-chart-ten)"]; // Left and right paddings of .color-picker-container element

      var CONTAINER_SIDE_PADDINGS_PX = 20; // Width of the .box element

      var BOX_WIDTH_PX = 30;

      var SelectV2ColorPickerComponent = function SelectV2ColorPickerComponent() {
        _classCallCheck(this, SelectV2ColorPickerComponent);
        ...
        this.overlayConfig = {
          ...
          maxWidth: this.cols ? this.cols * BOX_WIDTH_PX + CONTAINER_SIDE_PADDINGS_PX + "px" : "150px"
        };
        this.backgroundColors = CHART_PALETTE_CS1;
        this.defaultColor = "var(--nui-color-bg-secondary)";
      };

      SelectV2ColorPickerComponent.ɵfac = function SelectV2ColorPickerComponent_Factory(t) {
        return new (t || SelectV2ColorPickerComponent)();
      };

      SelectV2ColorPickerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2ColorPickerComponent,
        selectors: [["nui-select-v2-color-picker"]],
        decls: 5,
        vars: 4,
        consts: function consts() {
          var i18n_0;
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_COLOR_PICKER_SELECT_V2_COLOR_PICKER_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 1, "color-picker-select", 3, "overlayConfig", "syncWidth", "displayValueTemplate"], [1, "color-picker-container"], ["class", "d-inline-flex flex-wrap box", 4, "ngFor", "ngForOf"], ["colorSelectTemplate", ""], [1, "d-inline-flex", "flex-wrap", "box"], [1, "w-100", "h-100", "reset-box-sizes", 3, "value", "displayValueContext"], ["option", ""], [1, "color-picker-option"], [1, "color-picker-option__color-box"], ["class", "color-picker-option__glyph", 3, "mix-blend-mode", 4, "ngIf"], [1, "color-picker-option__glyph"], [1, "color-picker-input"], [1, "color-picker-input__box"], [1, "color-picker-input__color-box"], [1, "color-picker-input__toggle"], ["icon", "caret-down"]];
        },
        template: function SelectV2ColorPickerComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2", 0);
    ...
    /***/
    function NJQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2OptionsChangedExampleComponent", function () {
        return SelectV2OptionsChangedExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2OptionsChangedExampleComponent_nui_select_v2_option_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2OptionsChangedExampleComponent = /*#__PURE__*/function () {
        function SelectV2OptionsChangedExampleComponent() {
          _classCallCheck(this, SelectV2OptionsChangedExampleComponent);

          this.items = [];
          this.itemSet = [[$localize(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Item 1"]))), $localize(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["Item 2"]))), $localize(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["Item 3"]))), $localize(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["Item 4"])))], [$localize(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["Item 3"]))), $localize(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["Item 4"]))), $localize(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["Item 5"]))), $localize(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["Item 6"])))]];
          this.selectControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]();
        }

        _createClass(SelectV2OptionsChangedExampleComponent, [{
          key: "ngOnInit",
      ...
      SelectV2OptionsChangedExampleComponent.ɵfac = function SelectV2OptionsChangedExampleComponent_Factory(t) {
        return new (t || SelectV2OptionsChangedExampleComponent)();
      };

      SelectV2OptionsChangedExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2OptionsChangedExampleComponent,
        selectors: [["nui-select-v2-options-changed-example"]],
        hostAttrs: [1, "select-container"],
        decls: 11,
        vars: 4,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_OPTIONS_CHANGED_SELECT_V2_OPTIONS_CHANGED_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_6602753656016090774$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_OPTIONS_CHANGED_SELECT_V2_OPTIONS_CHANGED_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Set items: 1, 2, 3, 4");
            ...
            i18n_2 = $localize(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral([":\u241F88907de97f07da173cbae35e528068baaa303a9f\u241F6602753656016090774:Set items: 1, 2, 3, 4"])));
          }

          var i18n_4;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3366342520245221259$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_OPTIONS_CHANGED_SELECT_V2_OPTIONS_CHANGED_EXAMPLE_COMPONENT_TS_5 = goog.getMsg("Set items: 3, 4, 5, 6");
            ...
            i18n_4 = $localize(_templateObject15 || (_templateObject15 = _taggedTemplateLiteral([":\u241F546d7c2a5e1a2d4b895c66a8507f43a9800c1ef2\u241F3366342520245221259:Set items: 3, 4, 5, 6"])));
          }

          return [["placeholder", i18n_0, 3, "formControl"], ["select", ""], [3, "value", 4, "ngFor", "ngForOf"], ["nui-button", "", "type", "button", "displayStyle", "action", 3, "click"], i18n_2, i18n_4, [3, "value"]];
        },
        template: function SelectV2OptionsChangedExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2OptionsChangedExampleComponent_Template_button_click_7_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2OptionsChangedExampleComponent_Template_button_click_9_listener() {
    ...
    function OL(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = "<nui-select-v2 placeholder=\"Select Item\" i18n-placeholder [formControl]=\"selectControl\">\n    <nui-select-v2-option *ngFor=\"let item of items\" [value]=\"item\">{{item}}</nui-select-v2-option>\n</nui-select-v2>\n";
      /***/
    },
    ...
    function NT(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2Module", function () {
        return SelectV2Module;
      });
      /* harmony import */
      ...
      var SelectV2Module = function SelectV2Module() {
      ...
      SelectV2Module.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({
        ...
        providers: [{
          ...
          useFactory: function useFactory() {
            return __webpack_require__("5KeD");
          }
        }],
        imports: [[_nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiButtonModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiIconModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDividerModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiSelectV2Module"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiSwitchModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiValidationMessageModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiFormFieldModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDocsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiMessageModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_0__["ScrollingModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDialogModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiOverlayAdditionsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes)], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]]
      });

      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](SelectV2Module, {
          declarations: [_index__WEBPACK_IMPORTED_MODULE_4__["SelectV2BasicExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2DisabledExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2ErrorExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2InlineExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2DocsComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2GroupedItemsExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2StylingExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2VirtualScrollExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2OverlayConfigExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2ReactiveFormFieldExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2CustomizeOptionsExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2CustomControlExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2TestExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2CustomContentExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2OptionsChangedExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2GettingValueExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2SettingValueExampleComponent"], _index__WEBPACK_IMPORTED_MODULE_4__["SelectV2ColorPickerComponent"]],
          imports: [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiButtonModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiIconModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDividerModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiSelectV2Module"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["ReactiveFormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiSwitchModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiValidationMessageModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiFormFieldModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDocsModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiMessageModule"], _angular_cdk_scrolling__WEBPACK_IMPORTED_MODULE_0__["ScrollingModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiDialogModule"], _nova_ui_bits__WEBPACK_IMPORTED_MODULE_3__["NuiOverlayAdditionsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"]],
    ...
    /***/
    function eXU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Ghz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Gwx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function vco(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2DocsComponent", function () {
        return SelectV2DocsComponent;
      });
      /* harmony import */
      ...
      var _select_v2_basic_select_v2_basic_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../select-v2-basic/select-v2-basic.example.component */
      "ITiL");
      /* harmony import */


      var _select_v2_getting_value_select_v2_getting_value_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../select-v2-getting-value/select-v2-getting-value.example.component */
      "sLIz");
      /* harmony import */


      var _select_v2_setting_value_select_v2_setting_value_example_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../select-v2-setting-value/select-v2-setting-value.example.component */
      "Cq4+");
      /* harmony import */
      ...
      var _select_v2_customize_options_select_v2_customize_options_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../select-v2-customize-options/select-v2-customize-options.example.component */
      "h3Y2");
      /* harmony import */


      var _select_v2_custom_content_select_v2_custom_content_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../select-v2-custom-content/select-v2-custom-content.example.component */
      "Twss");
      /* harmony import */


      var _select_v2_grouped_items_select_v2_grouped_items_example_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ../select-v2-grouped-items/select-v2-grouped-items.example.component */
      "Z5mw");
      /* harmony import */


      var _select_v2_reactive_form_field_select_v2_reactive_form_field_example_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../select-v2-reactive-form-field/select-v2-reactive-form-field.example.component */
      "J1Qm");
      /* harmony import */


      var _select_v2_virtual_scroll_select_v2_virtual_scroll_example_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../select-v2-virtual-scroll/select-v2-virtual-scroll.example.component */
      "vRmy");
      /* harmony import */


      var _select_v2_disabled_select_v2_disabled_example_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../select-v2-disabled/select-v2-disabled.example.component */
      "GEoz");
      /* harmony import */


      var _select_v2_error_select_v2_error_example_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../select-v2-error/select-v2-error.example.component */
      "/Hvy");
      /* harmony import */


      var _select_v2_styling_select_v2_styling_example_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ../select-v2-styling/select-v2-styling.example.component */
      "y1aD");
      /* harmony import */


      var _select_v2_inline_select_v2_inline_example_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ../select-v2-inline/select-v2-inline.example.component */
      "Cj9S");
      /* harmony import */


      var _select_v2_overlay_config_select_v2_overlay_config_example_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ../select-v2-overlay-config/select-v2-overlay-config.example.component */
      "hoVv");
      /* harmony import */


      var _select_v2_custom_control_select_v2_custom_control_example_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ../select-v2-custom-control/select-v2-custom-control.example.component */
      "eoDd");
      /* harmony import */


      var _select_v2_color_picker_select_v2_color_picker_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(
      /*! ../select-v2-color-picker/select-v2-color-picker.component */
      "/ZZw");

      var SelectV2DocsComponent = function SelectV2DocsComponent() {
        _classCallCheck(this, SelectV2DocsComponent);
      };

      SelectV2DocsComponent.ɵfac = function SelectV2DocsComponent_Factory(t) {
        return new (t || SelectV2DocsComponent)();
      };

      SelectV2DocsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2DocsComponent,
        selectors: [["nui-select-v2-docs-example"]],
        decls: 430,
        vars: 8,
        consts: [["href", "../components/ComboboxV2Component.html", "target", "_blank"], ["filenamePrefix", "select-v2-basic", "exampleTitle", "Basic Usage"], ["filenamePrefix", "select-v2-getting-value", "exampleTitle", "Getting value"], ["href", "https://angular.io/guide/reactive-forms#replacing-a-form-control-value", "target", "_blank"], ["filenamePrefix", "select-v2-setting-value", "exampleTitle", "Setting value"], ["type", "info", 3, "allowDismiss"], ["filenamePrefix", "select-v2-customize-options", "exampleTitle", "Customize Options"], ["filenamePrefix", "select-v2-custom-content", "exampleTitle", "Custom Content"], ["filenamePrefix", "select-v2-grouped-items", "exampleTitle", "Grouped Options"], ["href", "../components/FormFieldComponent.html", "target", "_blank"], ["filenamePrefix", "select-v2-reactive-form-field", "exampleTitle", "Reactive form field"], ["href", "https://material.angular.io/cdk/scrolling/overview#virtual-scrolling", "target", "_blank"], ["href", "https://material.angular.io/cdk/scrolling/api"], ["type", "warning", 3, "allowDismiss"], ["filenamePrefix", "select-v2-virtual-scroll", "exampleTitle", "Virtual Scroll"], ["filenamePrefix", "select-v2-disabled", "exampleTitle", "Disabled Mode"], ["filenamePrefix", "select-v2-error", "exampleTitle", "Error state"], ["filenamePrefix", "select-v2-styling", "exampleTitle", "Styling"], ["filenamePrefix", "select-v2-inline", "exampleTitle", "Inline"], ["href", "https://material.angular.io/cdk/overlay/api#OverlayConfig"], ["filenamePrefix", "select-v2-overlay-config", "exampleTitle", "Overlay configuration"], ["filenamePrefix", "select-v2-custom-control", "exampleTitle", "Custom Control"], ["filenamePrefix", "select-v2-color-picker", "exampleTitle", "Color Picker"]],
        template: function SelectV2DocsComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function Kjx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Amdf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function CB5l(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Cj9S(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2InlineExampleComponent", function () {
        return SelectV2InlineExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2InlineExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2InlineExampleComponent_nui_select_v2_option_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 3);
      ...
      var SelectV2InlineExampleComponent = function SelectV2InlineExampleComponent() {
        _classCallCheck(this, SelectV2InlineExampleComponent);

        this.items = Array.from({
          length: 100
        }).map(function (_, i) {
          return $localize(_templateObject16 || (_templateObject16 = _taggedTemplateLiteral(["Item ", ""])), i);
        });
      };

      SelectV2InlineExampleComponent.ɵfac = function SelectV2InlineExampleComponent_Factory(t) {
        return new (t || SelectV2InlineExampleComponent)();
      };

      SelectV2InlineExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2InlineExampleComponent,
        selectors: [["nui-select-v2-inline-example"]],
        hostAttrs: [1, "select-container"],
        decls: 4,
        vars: 2,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_INLINE_SELECT_V2_INLINE_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject17 || (_templateObject17 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_INLINE_SELECT_V2_INLINE_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Select Item");
            ...
            i18n_2 = $localize(_templateObject18 || (_templateObject18 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 1, "d-inline-flex", 2, "margin-right", "15px"], [3, "value", 4, "ngFor", "ngForOf"], ["placeholder", i18n_2, 1, "d-inline-flex"], [3, "value"]];
        },
        template: function SelectV2InlineExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2", 0);
        ...
        directives: [_src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_1__["SelectV2Component"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _src_lib_select_v2_option_select_v2_option_component__WEBPACK_IMPORTED_MODULE_3__["SelectV2OptionComponent"]],
        encapsulation: 2
      });
      /***/
    },
    ...
    function Cq4(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2SettingValueExampleComponent", function () {
        return SelectV2SettingValueExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2SettingValueExampleComponent_nui_select_v2_option_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2SettingValueExampleComponent_nui_select_v2_option_13_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2-option", 3);
      ...
      var SelectV2SettingValueExampleComponent = /*#__PURE__*/function () {
        function SelectV2SettingValueExampleComponent() {
          _classCallCheck(this, SelectV2SettingValueExampleComponent);

          this.items = Array.from({
            length: 50
          }).map(function (_, i) {
            return $localize(_templateObject19 || (_templateObject19 = _taggedTemplateLiteral(["Item ", ""])), i);
          });
          this.selectControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]();
        }

        _createClass(SelectV2SettingValueExampleComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
      ...
      SelectV2SettingValueExampleComponent.ɵfac = function SelectV2SettingValueExampleComponent_Factory(t) {
        return new (t || SelectV2SettingValueExampleComponent)();
      };

      SelectV2SettingValueExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2SettingValueExampleComponent,
        selectors: [["nui-select-v2-setting-value-example"]],
        hostAttrs: [1, "select-container"],
        decls: 14,
        vars: 4,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_SETTING_VALUE_SELECT_V2_SETTING_VALUE_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject20 || (_templateObject20 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_SETTING_VALUE_SELECT_V2_SETTING_VALUE_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Select Item");
            ...
            i18n_2 = $localize(_templateObject21 || (_templateObject21 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["placeholder", i18n_2, 3, "formControl"], [3, "value"]];
        },
        template: function SelectV2SettingValueExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function E8B(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function EALM(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function FN6Y(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function GEoz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2DisabledExampleComponent", function () {
        return SelectV2DisabledExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2DisabledExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2DisabledExampleComponent = function SelectV2DisabledExampleComponent() {
        _classCallCheck(this, SelectV2DisabledExampleComponent);

        this.items = Array.from({
          length: 100
        }).map(function (_, i) {
          return {
            name: $localize(_templateObject22 || (_templateObject22 = _taggedTemplateLiteral(["Item ", ""])), i),
      ...
      SelectV2DisabledExampleComponent.ɵfac = function SelectV2DisabledExampleComponent_Factory(t) {
        return new (t || SelectV2DisabledExampleComponent)();
      };

      SelectV2DisabledExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2DisabledExampleComponent,
        selectors: [["nui-select-v2-disabled-example"]],
        hostAttrs: [1, "select-container"],
        decls: 4,
        vars: 3,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_DISABLED_SELECT_V2_DISABLED_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject23 || (_templateObject23 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_5704424605088380008$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_DISABLED_SELECT_V2_DISABLED_EXAMPLE_COMPONENT_TS_3 = goog.getMsg(" Toggle disabling\n");
            ...
            i18n_2 = $localize(_templateObject24 || (_templateObject24 = _taggedTemplateLiteral([":\u241F4fd336b63e20279fcb27a6a9db9e6c774507ccee\u241F5704424605088380008: Toggle disabling\n"])));
          }

          return [["placeholder", i18n_0, 1, "w-50", "d-inline-flex", 3, "isDisabled"], [3, "value", "isDisabled", 4, "ngFor", "ngForOf"], [1, "d-inline-flex", 2, "padding-left", "15px", 3, "value", "valueChange"], i18n_2, [3, "value", "isDisabled"]];
        },
        template: function SelectV2DisabledExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function SelectV2DisabledExampleComponent_Template_nui_switch_valueChange_2_listener($event) {
              return ctx.isSelectDisabled = $event;
            });
    ...
    /***/
    function ITiL(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2BasicExampleComponent", function () {
        return SelectV2BasicExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2BasicExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2BasicExampleComponent = function SelectV2BasicExampleComponent() {
        _classCallCheck(this, SelectV2BasicExampleComponent);

        this.items = Array.from({
          length: 50
        }).map(function (_, i) {
          return $localize(_templateObject25 || (_templateObject25 = _taggedTemplateLiteral(["Item ", ""])), i);
        });
        this.selectControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]();
      };

      SelectV2BasicExampleComponent.ɵfac = function SelectV2BasicExampleComponent_Factory(t) {
        return new (t || SelectV2BasicExampleComponent)();
      };

      SelectV2BasicExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2BasicExampleComponent,
        selectors: [["nui-select-v2-basic-example"]],
        hostAttrs: [1, "select-container"],
        decls: 2,
        vars: 2,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_BASIC_SELECT_V2_BASIC_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject26 || (_templateObject26 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 3, "formControl"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]];
        },
        template: function SelectV2BasicExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function J1Qm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ReactiveFormFieldExampleComponent", function () {
        return SelectV2ReactiveFormFieldExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2ReactiveFormFieldExampleComponent_nui_select_v2_option_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2ReactiveFormFieldExampleComponent = /*#__PURE__*/function () {
        function SelectV2ReactiveFormFieldExampleComponent(formBuilder) {
          _classCallCheck(this, SelectV2ReactiveFormFieldExampleComponent);

          this.formBuilder = formBuilder;
          this.items = Array.from({
            length: 100
          }).map(function (_, i) {
            return $localize(_templateObject27 || (_templateObject27 = _taggedTemplateLiteral(["Item ", ""])), i);
          });
        }

        _createClass(SelectV2ReactiveFormFieldExampleComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.fancyForm = this.formBuilder.group({
      ...
      SelectV2ReactiveFormFieldExampleComponent.ɵfac = function SelectV2ReactiveFormFieldExampleComponent_Factory(t) {
        return new (t || SelectV2ReactiveFormFieldExampleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]));
      };

      SelectV2ReactiveFormFieldExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2ReactiveFormFieldExampleComponent,
        selectors: [["nui-select-v2-reactive-form-field-example"]],
        hostAttrs: [1, "select-container"],
        decls: 6,
        vars: 3,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3797570084942068182$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_REACTIVE_FORM_FIELD_SELECT_V2_REACTIVE_FORM_FIELD_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select");
            ...
            i18n_0 = $localize(_templateObject28 || (_templateObject28 = _taggedTemplateLiteral([":\u241F9ca82952a6bc860b5391d5975322d8af8ceddfa4\u241F3797570084942068182:Select"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3367498155686111134$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_REACTIVE_FORM_FIELD_SELECT_V2_REACTIVE_FORM_FIELD_EXAMPLE_COMPONENT_TS_3 = goog.getMsg("Some pretty long text with hint");
            ...
            i18n_2 = $localize(_templateObject29 || (_templateObject29 = _taggedTemplateLiteral([":\u241Fe157d4486793f15c2f27fb0f1011c4e2781f6936\u241F3367498155686111134:Some pretty long text with hint"])));
          }

          var i18n_4;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_REACTIVE_FORM_FIELD_SELECT_V2_REACTIVE_FORM_FIELD_EXAMPLE_COMPONENT_TS_5 = goog.getMsg("Select Item");
            ...
            i18n_4 = $localize(_templateObject30 || (_templateObject30 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [[1, "nui-edge-definer", 2, "max-width", "30%", 3, "formGroup"], ["caption", i18n_0, "hint", i18n_2, "info", "text", 3, "control"], ["placeholder", i18n_4, "formControlName", "select"], [3, "value", 4, "ngFor", "ngForOf"], ["for", "required"], [3, "value"]];
        },
        template: function SelectV2ReactiveFormFieldExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
    ...
    /***/
    function NbFc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function RIDx(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function TSO1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _select_v2_basic_select_v2_basic_example_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./select-v2-basic/select-v2-basic.example.component */
      "ITiL");
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2BasicExampleComponent", function () {
        return _select_v2_basic_select_v2_basic_example_component__WEBPACK_IMPORTED_MODULE_0__["SelectV2BasicExampleComponent"];
      });
      /* harmony import */


      var _select_v2_docs_select_v2_docs_example_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./select-v2-docs/select-v2-docs.example.component */
      "7vco");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2DocsComponent", function () {
        return _select_v2_docs_select_v2_docs_example_component__WEBPACK_IMPORTED_MODULE_1__["SelectV2DocsComponent"];
      });
      /* harmony import */


      var _select_v2_grouped_items_select_v2_grouped_items_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./select-v2-grouped-items/select-v2-grouped-items.example.component */
      "Z5mw");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2GroupedItemsExampleComponent", function () {
        return _select_v2_grouped_items_select_v2_grouped_items_example_component__WEBPACK_IMPORTED_MODULE_2__["SelectV2GroupedItemsExampleComponent"];
      });
      /* harmony import */


      var _select_v2_disabled_select_v2_disabled_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./select-v2-disabled/select-v2-disabled.example.component */
      "GEoz");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2DisabledExampleComponent", function () {
        return _select_v2_disabled_select_v2_disabled_example_component__WEBPACK_IMPORTED_MODULE_3__["SelectV2DisabledExampleComponent"];
      });
      /* harmony import */


      var _select_v2_error_select_v2_error_example_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./select-v2-error/select-v2-error.example.component */
      "/Hvy");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ErrorExampleComponent", function () {
        return _select_v2_error_select_v2_error_example_component__WEBPACK_IMPORTED_MODULE_4__["SelectV2ErrorExampleComponent"];
      });
      /* harmony import */


      var _select_v2_inline_select_v2_inline_example_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./select-v2-inline/select-v2-inline.example.component */
      "Cj9S");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2InlineExampleComponent", function () {
        return _select_v2_inline_select_v2_inline_example_component__WEBPACK_IMPORTED_MODULE_5__["SelectV2InlineExampleComponent"];
      });
      /* harmony import */


      var _select_v2_styling_select_v2_styling_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./select-v2-styling/select-v2-styling.example.component */
      "y1aD");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2StylingExampleComponent", function () {
        return _select_v2_styling_select_v2_styling_example_component__WEBPACK_IMPORTED_MODULE_6__["SelectV2StylingExampleComponent"];
      });
      /* harmony import */


      var _select_v2_virtual_scroll_select_v2_virtual_scroll_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./select-v2-virtual-scroll/select-v2-virtual-scroll.example.component */
      "vRmy");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2VirtualScrollExampleComponent", function () {
        return _select_v2_virtual_scroll_select_v2_virtual_scroll_example_component__WEBPACK_IMPORTED_MODULE_7__["SelectV2VirtualScrollExampleComponent"];
      });
      /* harmony import */


      var _select_v2_overlay_config_select_v2_overlay_config_example_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./select-v2-overlay-config/select-v2-overlay-config.example.component */
      "hoVv");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2OverlayConfigExampleComponent", function () {
        return _select_v2_overlay_config_select_v2_overlay_config_example_component__WEBPACK_IMPORTED_MODULE_8__["SelectV2OverlayConfigExampleComponent"];
      });
      /* harmony import */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ReactiveFormFieldExampleComponent", function () {
        return _select_v2_reactive_form_field_select_v2_reactive_form_field_example_component__WEBPACK_IMPORTED_MODULE_9__["SelectV2ReactiveFormFieldExampleComponent"];
      });
      /* harmony import */


      var _select_v2_customize_options_select_v2_customize_options_example_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./select-v2-customize-options/select-v2-customize-options.example.component */
      "h3Y2");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2CustomizeOptionsExampleComponent", function () {
        return _select_v2_customize_options_select_v2_customize_options_example_component__WEBPACK_IMPORTED_MODULE_10__["SelectV2CustomizeOptionsExampleComponent"];
      });
      /* harmony import */


      var _select_v2_custom_control_select_v2_custom_control_example_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./select-v2-custom-control/select-v2-custom-control.example.component */
      "eoDd");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2CustomControlExampleComponent", function () {
        return _select_v2_custom_control_select_v2_custom_control_example_component__WEBPACK_IMPORTED_MODULE_11__["SelectV2CustomControlExampleComponent"];
      });
      /* harmony import */


      var _select_v2_test_select_v2_test_example_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./select-v2-test/select-v2-test.example.component */
      "ciDn");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2TestExampleComponent", function () {
        return _select_v2_test_select_v2_test_example_component__WEBPACK_IMPORTED_MODULE_12__["SelectV2TestExampleComponent"];
      });
      /* harmony import */


      var _select_v2_custom_content_select_v2_custom_content_example_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./select-v2-custom-content/select-v2-custom-content.example.component */
      "Twss");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2CustomContentExampleComponent", function () {
        return _select_v2_custom_content_select_v2_custom_content_example_component__WEBPACK_IMPORTED_MODULE_13__["SelectV2CustomContentExampleComponent"];
      });
      /* harmony import */


      var _select_v2_options_changed_select_v2_options_changed_example_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(
      /*! ./select-v2-options-changed/select-v2-options-changed.example.component */
      "0NJQ");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2OptionsChangedExampleComponent", function () {
        return _select_v2_options_changed_select_v2_options_changed_example_component__WEBPACK_IMPORTED_MODULE_14__["SelectV2OptionsChangedExampleComponent"];
      });
      /* harmony import */


      var _select_v2_getting_value_select_v2_getting_value_example_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./select-v2-getting-value/select-v2-getting-value.example.component */
      "sLIz");
      /* harmony reexport (safe) */


      __webpack_require__.d(__webpack_exports__, "SelectV2GettingValueExampleComponent", function () {
        return _select_v2_getting_value_select_v2_getting_value_example_component__WEBPACK_IMPORTED_MODULE_15__["SelectV2GettingValueExampleComponent"];
      });
      /* harmony import */


      var _select_v2_setting_value_select_v2_setting_value_example_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(
      /*! ./select-v2-setting-value/select-v2-setting-value.example.component */
      "Cq4+");
      /* harmony reexport (safe) */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2SettingValueExampleComponent", function () {
        return _select_v2_setting_value_select_v2_setting_value_example_component__WEBPACK_IMPORTED_MODULE_16__["SelectV2SettingValueExampleComponent"];
      });
      /* harmony import */
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2ColorPickerComponent", function () {
        return _select_v2_color_picker_select_v2_color_picker_component__WEBPACK_IMPORTED_MODULE_17__["SelectV2ColorPickerComponent"];
      });
      /***/
    ...
    /***/
    function Twss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2CustomContentExampleComponent", function () {
        return SelectV2CustomContentExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2CustomContentExampleComponent_nui_select_v2_option_group_2_nui_select_v2_option_6_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2CustomContentExampleComponent_nui_select_v2_option_group_2_nui_select_v2_option_6_Template_button_click_2_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r8);

            var ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"](2);

            return ctx_r7.actionSimulation($event);
          });
      ...
      function SelectV2CustomContentExampleComponent_nui_select_v2_option_group_2_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2CustomContentExampleComponent_nui_select_v2_option_group_2_Template_button_click_1_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r10);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]();

            return ctx_r9.actionSimulation();
          });
      ...
      function SelectV2CustomContentExampleComponent_ng_template_3_div_1_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var context_r11 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
      ...
      function SelectV2CustomContentExampleComponent_ng_template_3_ng_template_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2CustomContentExampleComponent_ng_template_3_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          var context_r11 = ctx.$implicit;
          var open_r12 = ctx.open;
      ...
      var SelectV2CustomContentExampleComponent = /*#__PURE__*/function () {
        function SelectV2CustomContentExampleComponent(toastService) {
          _classCallCheck(this, SelectV2CustomContentExampleComponent);

          this.toastService = toastService;
          this.items = [{
            headerName: $localize(_templateObject31 || (_templateObject31 = _taggedTemplateLiteral(["Saved Data Filters"]))),
            options: [{
              id: 1,
              name: $localize(_templateObject32 || (_templateObject32 = _taggedTemplateLiteral(["All Services"]))),
              icon: "check"
            }, {
              id: 2,
              name: $localize(_templateObject33 || (_templateObject33 = _taggedTemplateLiteral(["Unified Communication Apps"]))),
              icon: "execute"
            }]
          }];
        }

        _createClass(SelectV2CustomContentExampleComponent, [{
          key: "actionSimulation",
          value: function actionSimulation(event) {
            this.toastService.info({
              message: $localize(_templateObject34 || (_templateObject34 = _taggedTemplateLiteral(["Action Occurred!"])))
            });
      ...
      SelectV2CustomContentExampleComponent.ɵfac = function SelectV2CustomContentExampleComponent_Factory(t) {
        return new (t || SelectV2CustomContentExampleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["ToastService"]));
      };

      SelectV2CustomContentExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2CustomContentExampleComponent,
        selectors: [["nui-select-v2-custom-content-example"]],
        decls: 5,
        vars: 2,
        consts: function consts() {
          var i18n_0;
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_CUSTOM_CONTENT_SELECT_V2_CUSTOM_CONTENT_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
    ...
    /***/
    function UPA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function UnJU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function X3o(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function YCyW(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Z5mw(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2GroupedItemsExampleComponent", function () {
        return SelectV2GroupedItemsExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_select_v2_option_group_select_v2_option_group_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ../../../../../../src/lib/select-v2/option-group/select-v2-option-group.component */
      "2nXI");
      /* harmony import */
      ...
      function SelectV2GroupedItemsExampleComponent_nui_select_v2_option_group_1_nui_select_v2_option_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2GroupedItemsExampleComponent_nui_select_v2_option_group_1_nui_divider_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-divider", 6);
        }
      }

      function SelectV2GroupedItemsExampleComponent_nui_select_v2_option_group_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2GroupedItemsExampleComponent = function SelectV2GroupedItemsExampleComponent() {
        _classCallCheck(this, SelectV2GroupedItemsExampleComponent);

        this.items = Array.from({
          length: 10
        }).map(function (_, i) {
          return {
            header: $localize(_templateObject36 || (_templateObject36 = _taggedTemplateLiteral(["Header line ", ""])), i + 1),
            items: Array.from({
              length: getRandomNumberTo(5)
            }).map(function (v, n) {
              return {
                id: "value-".concat(i),
                name: $localize(_templateObject37 || (_templateObject37 = _taggedTemplateLiteral(["Item ", ""])), n + 1)
              };
            })
          };
        });
      ...
      SelectV2GroupedItemsExampleComponent.ɵfac = function SelectV2GroupedItemsExampleComponent_Factory(t) {
        return new (t || SelectV2GroupedItemsExampleComponent)();
      };

      SelectV2GroupedItemsExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2GroupedItemsExampleComponent,
        selectors: [["nui-select-v2-grouped-items-example"]],
        hostAttrs: [1, "select-container"],
        decls: 2,
        vars: 1,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_GROUPED_ITEMS_SELECT_V2_GROUPED_ITEMS_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
          ...
          return [["placeholder", i18n_0], [4, "ngFor", "ngForOf"], [1, "nui-select-v2-option-group--header"], [3, "value", 4, "ngFor", "ngForOf"], ["size", "extra-small", 4, "ngIf"], [3, "value"], ["size", "extra-small"]];
        },
        template: function SelectV2GroupedItemsExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2", 0);
    ...
    /***/
    function aJWh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ciDn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2TestExampleComponent", function () {
        return SelectV2TestExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../../../../src/lib/select-v2/select/select-v2.component */
      "UpNd");
      /* harmony import */
      ...
      var _src_lib_select_v2_option_group_select_v2_option_group_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../../../../../../src/lib/select-v2/option-group/select-v2-option-group.component */
      "2nXI");
      /* harmony import */


      var _src_lib_divider_divider_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ../../../../../../src/lib/divider/divider.component */
      "UGtJ");
      /* harmony import */
      ...
      var _c0 = ["custom_control"];

      function SelectV2TestExampleComponent_nui_select_v2_option_9_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2TestExampleComponent_ng_container_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function SelectV2TestExampleComponent_nui_select_v2_option_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_nui_select_v2_option_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_nui_select_v2_option_35_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2TestExampleComponent_ng_container_40_nui_select_v2_option_4_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_ng_container_40_nui_divider_5_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-divider", 49);
        }
      }

      function SelectV2TestExampleComponent_ng_container_40_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
        ...
        if (rf & 2) {
          var itemGroup_r30 = ctx.$implicit;
      ...
      function SelectV2TestExampleComponent_ng_container_48_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function SelectV2TestExampleComponent_ng_container_51_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function SelectV2TestExampleComponent_ng_container_57_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
      ...
      function SelectV2TestExampleComponent_nui_select_v2_option_62_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_nui_select_v2_option_73_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_ng_template_86_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2TestExampleComponent_ng_template_86_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          var open_r41 = ctx.open;

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          var _r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](95);
      ...
      function SelectV2TestExampleComponent_ng_template_88_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 58);
      ...
      function SelectV2TestExampleComponent_ng_template_88_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 55);
      ...
      function SelectV2TestExampleComponent_ng_template_90_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 58);
        ...
        if (rf & 2) {
          var item_r48 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
      ...
      function SelectV2TestExampleComponent_ng_template_90_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 55);
      ...
      function SelectV2TestExampleComponent_ng_template_92_nui_select_v2_option_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-select-v2-option", 40);
      ...
      function SelectV2TestExampleComponent_ng_template_92_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "nui-dialog-header", 60);

          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("closed", function SelectV2TestExampleComponent_ng_template_92_Template_nui_dialog_header_closed_0_listener() {
            var close_r52 = ctx.close;
            return close_r52();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_ng_template_92_Template_button_click_7_listener() {
            var close_r52 = ctx.close;
            return close_r52();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_ng_template_92_Template_button_click_9_listener() {
            var close_r52 = ctx.close;
            return close_r52();
          });
      ...
      function SelectV2TestExampleComponent_ng_template_94_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2TestExampleComponent = /*#__PURE__*/function () {
        function SelectV2TestExampleComponent(dialogService, formBuilder) {
          _classCallCheck(this, SelectV2TestExampleComponent);

          this.dialogService = dialogService;
          this.formBuilder = formBuilder;
          this.handleClicksOutside = false;
          this.iconItems = ["status_warning", "status_up", "status_critical", "status_reserved", "status_unplugged", "status_unknown", "status_down", "status_missing", "status_sleep"]; // Datasources
          ...
          this.itemsDisplayValue = Array.from({
            length: 100
          }).map(function (_, i) {
            return {
              id: "value-".concat(i),
              name: $localize(_templateObject40 || (_templateObject40 = _taggedTemplateLiteral(["Item ", ""])), i),
              icon: "status_warning",
              disabled: !!(i % 2)
            };
          });
          this.itemsWithIconsOnly = this.iconItems.map(function (icon, i) {
            return {
              id: "value-".concat(i),
              icon: icon
            };
          ...
          this.groupedItems = Array.from({
            ...
            return {
              header: $localize(_templateObject41 || (_templateObject41 = _taggedTemplateLiteral(["Header line ", ""])), i + 1),
              items: Array.from({
                length: 5
              }).map(function (v, n) {
                return {
                  id: "value-".concat(i),
                  name: $localize(_templateObject42 || (_templateObject42 = _taggedTemplateLiteral(["Item ", ""])), n + 1)
                };
              })
            };
          }); // Form

          this.selectControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormControl"](); // Test
        ...
        _createClass(SelectV2TestExampleComponent, [{
          key: "open",
          ...
          value: function ngOnInit() {
            ...
            this.selectControl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (value) {
          ...
          value: function ngAfterViewInit() {
            ...
            this.select.clickOutsideDropdown.subscribe(function () {
              if (_this2.handleClicksOutside) {
                _this2.select.hideDropdown();
              }
            });
          }
        }, {
      ...
      SelectV2TestExampleComponent.ɵfac = function SelectV2TestExampleComponent_Factory(t) {
        return new (t || SelectV2TestExampleComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_nova_ui_bits__WEBPACK_IMPORTED_MODULE_2__["DialogService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
      };

      SelectV2TestExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: SelectV2TestExampleComponent,
        selectors: [["nui-select-v2-test-example"]],
        viewQuery: function SelectV2TestExampleComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_2 = goog.getMsg("Select Item");
            ...
            i18n_1 = $localize(_templateObject43 || (_templateObject43 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_3;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3797570084942068182$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_4 = goog.getMsg("Select");
            ...
            i18n_3 = $localize(_templateObject44 || (_templateObject44 = _taggedTemplateLiteral([":\u241F9ca82952a6bc860b5391d5975322d8af8ceddfa4\u241F3797570084942068182:Select"])));
          }

          var i18n_5;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3367498155686111134$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_6 = goog.getMsg("Some pretty long text with hint");
            ...
            i18n_5 = $localize(_templateObject45 || (_templateObject45 = _taggedTemplateLiteral([":\u241Fe157d4486793f15c2f27fb0f1011c4e2781f6936\u241F3367498155686111134:Some pretty long text with hint"])));
          }

          var i18n_7;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_8 = goog.getMsg("Select Item");
            ...
            i18n_7 = $localize(_templateObject46 || (_templateObject46 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_9;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8999046125839025839$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_10 = goog.getMsg(" This field is required ");
            ...
            i18n_9 = $localize(_templateObject47 || (_templateObject47 = _taggedTemplateLiteral([":\u241F8eb0e5b7a8ec1199d38c9e92ca26bd4b3aae7f2c\u241F8999046125839025839: This field is required "])));
          }

          var i18n_11;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_12 = goog.getMsg("Select Item");
            ...
            i18n_11 = $localize(_templateObject48 || (_templateObject48 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_13;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_14 = goog.getMsg("Select Item");
            ...
            i18n_13 = $localize(_templateObject49 || (_templateObject49 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_15;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_16 = goog.getMsg("Select Item");
            ...
            i18n_15 = $localize(_templateObject50 || (_templateObject50 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_17;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_18 = goog.getMsg("Select Item");
            ...
            i18n_17 = $localize(_templateObject51 || (_templateObject51 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_19;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_20 = goog.getMsg("Select Item");
            ...
            i18n_19 = $localize(_templateObject52 || (_templateObject52 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_21;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_22 = goog.getMsg("Select Item");
            ...
            i18n_21 = $localize(_templateObject53 || (_templateObject53 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_23;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_24 = goog.getMsg("Select Item");
            ...
            i18n_23 = $localize(_templateObject54 || (_templateObject54 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_25;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3708095263074810002$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_26 = goog.getMsg("Call dialog with select");
            ...
            i18n_25 = $localize(_templateObject55 || (_templateObject55 = _taggedTemplateLiteral([":\u241F0c06003bbd90ee40def5d1978754ab83b38604e5\u241F3708095263074810002:Call dialog with select"])));
          }

          var i18n_27;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_28 = goog.getMsg("Select Item");
            ...
            i18n_27 = $localize(_templateObject56 || (_templateObject56 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_29;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1644749003923884153$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS_30 = goog.getMsg(" Close on focus-out ");
            ...
            i18n_29 = $localize(_templateObject57 || (_templateObject57 = _taggedTemplateLiteral([":\u241F7ed18d46de8405c63206204bd0538ffaf84de78b\u241F1644749003923884153: Close on focus-out "])));
          }

          var i18n_31;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1628382286062172232$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__32 = goog.getMsg("{$interpolation}", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_31 = $localize(_templateObject58 || (_templateObject58 = _taggedTemplateLiteral([":\u241Fbbffadc040d79a90f05c750b360e43a0cadce635\u241F1628382286062172232:", ":INTERPOLATION:"])), "\uFFFD0\uFFFD");
          }

          var i18n_33;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_7666056425885373480$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__34 = goog.getMsg(" {$interpolation} ", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_33 = $localize(_templateObject59 || (_templateObject59 = _taggedTemplateLiteral([":\u241F5ee16d9d35f2f7d16dd97075d0c872990fb85361\u241F7666056425885373480: ", ":INTERPOLATION: "])), "\uFFFD0\uFFFD");
          }

          var i18n_35;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1628382286062172232$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__36 = goog.getMsg("{$interpolation}", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_35 = $localize(_templateObject60 || (_templateObject60 = _taggedTemplateLiteral([":\u241Fbbffadc040d79a90f05c750b360e43a0cadce635\u241F1628382286062172232:", ":INTERPOLATION:"])), "\uFFFD0\uFFFD");
          }

          var i18n_37;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_7005353892180637230$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__38 = goog.getMsg(" Name is {$interpolation} and icon is {$startTagNuiIcon}{$closeTagNuiIcon}", {
              "interpolation": "\uFFFD0\uFFFD",
              "startTagNuiIcon": "\uFFFD#2\uFFFD",
              "closeTagNuiIcon": "\uFFFD/#2\uFFFD"
            });
            ...
            i18n_37 = $localize(_templateObject61 || (_templateObject61 = _taggedTemplateLiteral([":\u241F2f5afd47f576d59da5785dbdd5fce9a950aeeab0\u241F7005353892180637230: Name is ", ":INTERPOLATION: and icon is ", ":START_TAG_NUI_ICON:", ":CLOSE_TAG_NUI_ICON:"])), "\uFFFD0\uFFFD", "\uFFFD#2\uFFFD", "\uFFFD/#2\uFFFD");
          }

          var i18n_39;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_3208343296639145808$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__40 = goog.getMsg(" {$interpolation} ", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_39 = $localize(_templateObject62 || (_templateObject62 = _taggedTemplateLiteral([":\u241F4e38a2ad9f05eb609c90a420ea05a96beda64813\u241F3208343296639145808: ", ":INTERPOLATION: "])), "\uFFFD0\uFFFD");
          }

          var i18n_41;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_2981777175439482920$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__42 = goog.getMsg(" {$interpolation} ", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_41 = $localize(_templateObject63 || (_templateObject63 = _taggedTemplateLiteral([":\u241Fc59c5fd11ab937166bf17bdc5482bd87f249d0e9\u241F2981777175439482920: ", ":INTERPOLATION: "])), "\uFFFD0\uFFFD");
          }

          var i18n_43;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1888320862951610212$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__44 = goog.getMsg(" {$interpolation} ", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_43 = $localize(_templateObject64 || (_templateObject64 = _taggedTemplateLiteral([":\u241F5639aa83f522fbbc640f350ddc0775e01898cbef\u241F1888320862951610212: ", ":INTERPOLATION: "])), "\uFFFD0\uFFFD");
          }

          var i18n_45;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1628382286062172232$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__46 = goog.getMsg("{$interpolation}", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_45 = $localize(_templateObject65 || (_templateObject65 = _taggedTemplateLiteral([":\u241Fbbffadc040d79a90f05c750b360e43a0cadce635\u241F1628382286062172232:", ":INTERPOLATION:"])), "\uFFFD0\uFFFD");
          }

          var i18n_47;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1222525096397002861$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__48 = goog.getMsg(" {$interpolation} ", {
              "interpolation": "\uFFFD0\uFFFD"
            });
            ...
            i18n_47 = $localize(_templateObject66 || (_templateObject66 = _taggedTemplateLiteral([":\u241F82959a3e279b4b9d78fdad06f9c94f0fc77c4149\u241F1222525096397002861: ", ":INTERPOLATION: "])), "\uFFFD0\uFFFD");
          }

          var i18n_49;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_5892089246202495025$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__50 = goog.getMsg("Dialog title");
            ...
            i18n_49 = $localize(_templateObject67 || (_templateObject67 = _taggedTemplateLiteral([":\u241Feeb379308b8767b98aa0d27308f4f8dd6b46e559\u241F5892089246202495025:Dialog title"])));
          }

          var i18n_51;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__52 = goog.getMsg("Select Item");
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            ...
            i18n_53 = $localize(_templateObject69 || (_templateObject69 = _taggedTemplateLiteral([":\u241Ff62f9e2e728dea80e19b1e7a6f61424d55bab5ea\u241F7188163738299238705: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam maximus faucibus bibendum. Aenean feugiat interdum leo sed posuere. Etiam at pulvinar enim, nec interdum purus. Duis elit metus, lobortis vitae quam a, malesuada cursus quam. Duis vel lacinia purus. Maecenas eget arcu ac ante sagittis eleifend vel ut purus. Pellentesque sit amet semper ipsum, eu vulputate tortor. Aliquam vitae nisi augue. Duis non erat sit amet sem venenatis accumsan at ullamcorper lorem. Morbi non turpis nibh. "])));
          }

          var i18n_55;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_7452095619502551190$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__56 = goog.getMsg(" Cancel ");
            ...
            i18n_55 = $localize(_templateObject70 || (_templateObject70 = _taggedTemplateLiteral([":\u241Fbf844a41a29961b6dacc48a20eaf97bef0cf5013\u241F7452095619502551190: Cancel "])));
          }

          var i18n_57;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_4946554391652567902$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS__58 = goog.getMsg(" Action ");
            ...
            i18n_57 = $localize(_templateObject71 || (_templateObject71 = _taggedTemplateLiteral([":\u241F01b5385da84ee4b609f8273d7ae56600c3fb3cbe\u241F4946554391652567902: Action "])));
          }

          var i18n_59;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_1628382286062172232$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_TEST_SELECT_V2_TEST_EXAMPLE_COMPONENT_TS___60 = goog.getMsg("{$interpolation}", {
              "interpolation": "\uFFFD0\uFFFD"
            });
        ...
        template: function SelectV2TestExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_Template_button_click_65_listener() {
              _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r59);

              var _r21 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](93);

              return ctx.open(_r21);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_Template_button_click_75_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_Template_button_click_78_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SelectV2TestExampleComponent_Template_button_click_81_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function SelectV2TestExampleComponent_Template_nui_switch_valueChange_84_listener($event) {
          ...
          if (rf & 2) {
            ...
            var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](89);

            var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](91);
    ...
    function eoDd(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2CustomControlExampleComponent", function () {
        return SelectV2CustomControlExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_switch_switch_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../../../../src/lib/switch/switch.component */
      "6CEj");
      /* harmony import */
      ...
      function SelectV2CustomControlExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2CustomControlExampleComponent = /*#__PURE__*/function () {
        function SelectV2CustomControlExampleComponent() {
          _classCallCheck(this, SelectV2CustomControlExampleComponent);
        ...
        _createClass(SelectV2CustomControlExampleComponent, [{
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            var _this3 = this;

            this.select.clickOutsideDropdown.subscribe(function () {
              if (_this3.handleClicksOutside) {
                _this3.select.hideDropdown();
              }
            });
          }
        }, {
      ...
      SelectV2CustomControlExampleComponent.ɵfac = function SelectV2CustomControlExampleComponent_Factory(t) {
        return new (t || SelectV2CustomControlExampleComponent)();
      };

      SelectV2CustomControlExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2CustomControlExampleComponent,
        selectors: [["nui-select-v2-custom-control-example"]],
        viewQuery: function SelectV2CustomControlExampleComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        hostAttrs: [1, "select-container", "d-flex", "justify-content-between"],
        decls: 12,
        vars: 3,
        consts: function consts() {
          var i18n_0;
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_CUSTOM_CONTROL_SELECT_V2_CUSTOM_CONTROL_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject74 || (_templateObject74 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          var i18n_2;

          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_7190911341416824783$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_CUSTOM_CONTROL_SELECT_V2_CUSTOM_CONTROL_EXAMPLE_COMPONENT_TS_3 = goog.getMsg(" Close on focus-out ");
            ...
            i18n_2 = $localize(_templateObject75 || (_templateObject75 = _taggedTemplateLiteral([":\u241F5a845ece889b921123b84c73a01faa22aa7a0eac\u241F7190911341416824783: Close on focus-out "])));
          }

          return [["placeholder", i18n_0, 1, "w-25", 3, "manualDropdownControl"], [3, "value", 4, "ngFor", "ngForOf"], [1, "ml-4", "d-flex", "w-75"], ["nui-button", "", "type", "button", 1, "mr-3", 3, "click"], [1, "d-flex", "align-items-center"], [3, "value", "valueChange"], i18n_2, [3, "value"]];
        },
        template: function SelectV2CustomControlExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2", 0);
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2CustomControlExampleComponent_Template_button_click_3_listener($event) {
              return ctx.showList($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2CustomControlExampleComponent_Template_button_click_5_listener($event) {
              return ctx.hideList($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function SelectV2CustomControlExampleComponent_Template_button_click_7_listener($event) {
              return ctx.toggleList($event);
            });
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("valueChange", function SelectV2CustomControlExampleComponent_Template_nui_switch_valueChange_10_listener($event) {
              return ctx.handleClicksOutside = $event;
            });
    ...
    /***/
    function fEfU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function gp4e(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function h3Y2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2CustomizeOptionsExampleComponent", function () {
        return SelectV2CustomizeOptionsExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2CustomizeOptionsExampleComponent_nui_select_v2_option_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2CustomizeOptionsExampleComponent_ng_template_3_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div", 10);
      ...
      function SelectV2CustomizeOptionsExampleComponent_ng_template_3_ng_template_3_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2CustomizeOptionsExampleComponent_ng_template_3_Template(rf, ctx) {
        if (rf & 1) {
        ...
        if (rf & 2) {
          ...
          var _r7 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](4);
      ...
      var SelectV2CustomizeOptionsExampleComponent = /*#__PURE__*/function () {
        function SelectV2CustomizeOptionsExampleComponent() {
          var _this4 = this;

          _classCallCheck(this, SelectV2CustomizeOptionsExampleComponent);
          ...
          this.items = Array.from({
            ...
            return {
              id: "value-".concat(i),
              name: $localize(_templateObject76 || (_templateObject76 = _taggedTemplateLiteral(["Item ", ""])), i),
              icon: _this4.getRandomIcon()
            };
          });
          this.selectControl = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControl"]();
        }

        _createClass(SelectV2CustomizeOptionsExampleComponent, [{
          key: "getRandomIcon",
      ...
      SelectV2CustomizeOptionsExampleComponent.ɵfac = function SelectV2CustomizeOptionsExampleComponent_Factory(t) {
        return new (t || SelectV2CustomizeOptionsExampleComponent)();
      };

      SelectV2CustomizeOptionsExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2CustomizeOptionsExampleComponent,
        selectors: [["nui-select-v2-customize-options-example"]],
        hostAttrs: [1, "select-container"],
        decls: 5,
        vars: 3,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_CUSTOMIZE_OPTIONS_SELECT_V2_CUSTOMIZE_OPTIONS_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
        ...
        directives: [_src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_2__["SelectV2Component"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["NgControlStatus"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormControlDirective"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _src_lib_select_v2_option_select_v2_option_component__WEBPACK_IMPORTED_MODULE_4__["SelectV2OptionComponent"], _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_5__["IconComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgIf"]],
        encapsulation: 2
      });
      /***/
    },
    ...
    /***/
    function hTve(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<nui-select-v2 placeholder=\"Select Item\" i18n-placeholder [overlayConfig]=\"overlayConfig\" [syncWidth]=\"false\">\n    <nui-select-v2-option *ngFor=\"let item of items\" [value]=\"item\">{{ item }}</nui-select-v2-option>\n</nui-select-v2>\n";
      /***/
    },
    ...
    /***/
    function hlfU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function hoVv(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2OverlayConfigExampleComponent", function () {
        return SelectV2OverlayConfigExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2OverlayConfigExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2-option", 2);
      ...
      var SelectV2OverlayConfigExampleComponent = function SelectV2OverlayConfigExampleComponent() {
        _classCallCheck(this, SelectV2OverlayConfigExampleComponent);
      ...
      SelectV2OverlayConfigExampleComponent.ɵfac = function SelectV2OverlayConfigExampleComponent_Factory(t) {
        return new (t || SelectV2OverlayConfigExampleComponent)();
      };

      SelectV2OverlayConfigExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2OverlayConfigExampleComponent,
        selectors: [["nui-select-v2-overlay-config-example"]],
        hostAttrs: [1, "select-container"],
        decls: 2,
        vars: 3,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_OVERLAY_CONFIG_SELECT_V2_OVERLAY_CONFIG_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject79 || (_templateObject79 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 3, "overlayConfig", "syncWidth"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]];
        },
        template: function SelectV2OverlayConfigExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2", 0);
        ...
        directives: [_src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_2__["SelectV2Component"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["NgForOf"], _src_lib_select_v2_option_select_v2_option_component__WEBPACK_IMPORTED_MODULE_4__["SelectV2OptionComponent"]],
        encapsulation: 2
      });
      /***/
    },
    ...
    /***/
    function hyTk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function jIGl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function kGRe(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function m4Yc(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function o9Un(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<nui-select-v2 class=\"d-inline-flex\" placeholder=\"Select Item\" i18n-placeholder style=\"margin-right: 15px;\">\n    <nui-select-v2-option *ngFor=\"let item of items\" [value]=\"item\">{{item}} </nui-select-v2-option>\n</nui-select-v2>\n\n<nui-select-v2 class=\"d-inline-flex\" placeholder=\"Select Item\" i18n-placeholder>\n    <nui-select-v2-option *ngFor=\"let item of items\" [value]=\"item\">{{item}}</nui-select-v2-option>\n</nui-select-v2>\n";
      /***/
    },
    ...
    /***/
    function oOWr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ozD1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function pge4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function qAK4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function sLIz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2GettingValueExampleComponent", function () {
        return SelectV2GettingValueExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../../../../../../src/lib/select-v2/select/select-v2.component */
      "UpNd");
      /* harmony import */
      ...
      var _c0 = ["selectValueSelectedExample"];

      function SelectV2GettingValueExampleComponent_nui_select_v2_option_6_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function SelectV2GettingValueExampleComponent_nui_select_v2_option_16_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementStart"](0, "nui-select-v2-option", 6);
      ...
      var SelectV2GettingValueExampleComponent = /*#__PURE__*/function () {
        function SelectV2GettingValueExampleComponent() {
          _classCallCheck(this, SelectV2GettingValueExampleComponent);
        ...
        _createClass(SelectV2GettingValueExampleComponent, [{
          key: "ngAfterViewInit",
          value: function ngAfterViewInit() {
            var _this5 = this;

            this.selectValueSelectedExample.valueSelected.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (value) {
              return _this5.selectValueSelectedValue = value;
      ...
      SelectV2GettingValueExampleComponent.ɵfac = function SelectV2GettingValueExampleComponent_Factory(t) {
        return new (t || SelectV2GettingValueExampleComponent)();
      };

      SelectV2GettingValueExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
        type: SelectV2GettingValueExampleComponent,
        selectors: [["nui-select-v2-getting-value-example"]],
        viewQuery: function SelectV2GettingValueExampleComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_GETTING_VALUE_SELECT_V2_GETTING_VALUE_EXAMPLE_COMPONENT_TS_2 = goog.getMsg("Select Item");
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_GETTING_VALUE_SELECT_V2_GETTING_VALUE_EXAMPLE_COMPONENT_TS_4 = goog.getMsg("Select Item");
            ...
            i18n_3 = $localize(_templateObject82 || (_templateObject82 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_1], ["selectValueExample", ""], [3, "value", 4, "ngFor", "ngForOf"], [1, "my-3"], ["placeholder", i18n_3], ["selectValueSelectedExample", ""], [3, "value"]];
        },
        template: function SelectV2GettingValueExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
        ...
        directives: [_src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_4__["SelectV2Component"], _angular_common__WEBPACK_IMPORTED_MODULE_5__["NgForOf"], _src_lib_select_v2_option_select_v2_option_component__WEBPACK_IMPORTED_MODULE_6__["SelectV2OptionComponent"]],
        encapsulation: 2
      });
      /***/
    },
    ...
    /***/
    function sYsV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = ".select-test-focus-drop {\n    height: 1px;\n    width: 1px;\n}\n\n.custom-select-styles.nui-overlay-panel {\n    .nui-overlay {\n        height: 200px;\n        background-color: deepskyblue;\n        border-radius: 5%;\n    }\n}\n";
      /***/
    },
    ...
    /***/
    function t3Xk(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function uXSP(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function vRmy(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2VirtualScrollExampleComponent", function () {
        return SelectV2VirtualScrollExampleComponent;
      });
      /* harmony import */
      ...
      var _src_lib_select_v2_select_select_v2_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../../../../src/lib/select-v2/select/select-v2.component */
      "UpNd");
      /* harmony import */
      ...
      function SelectV2VirtualScrollExampleComponent_div_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var SelectV2VirtualScrollExampleComponent = /*#__PURE__*/function () {
        ...
        _createClass(SelectV2VirtualScrollExampleComponent, [{
          key: "handleClick",
          ...
          value: function ngAfterViewInit() {
            ...
            this.select.valueSelected.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroy$)).subscribe(function (selectionText) {
              _this6.scrollOffset = _this6.viewport.measureScrollOffset();
            });
          }
        }, {
          key: "ngOnDestroy",
      ...
      SelectV2VirtualScrollExampleComponent.ɵfac = function SelectV2VirtualScrollExampleComponent_Factory(t) {
        return new (t || SelectV2VirtualScrollExampleComponent)();
      };

      SelectV2VirtualScrollExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineComponent"]({
        type: SelectV2VirtualScrollExampleComponent,
        selectors: [["nui-select-v2-virtual-scroll-example"]],
        viewQuery: function SelectV2VirtualScrollExampleComponent_Query(rf, ctx) {
          if (rf & 1) {
        ...
        hostAttrs: [1, "select-container"],
        hostBindings: function SelectV2VirtualScrollExampleComponent_HostBindings(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵlistener"]("click", function SelectV2VirtualScrollExampleComponent_click_HostBindingHandler($event) {
        ...
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_VIRTUAL_SCROLL_SELECT_V2_VIRTUAL_SCROLL_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
        ...
        template: function SelectV2VirtualScrollExampleComponent_Template(rf, ctx) {
          ...
          if (rf & 2) {
            _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵproperty"]("overlayConfig", _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵpureFunction0"](7, _c2))("formControl", ctx.selectControl);
    ...
    /***/
    function xVRf(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function xdqU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function y1aD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SelectV2StylingExampleComponent", function () {
        return SelectV2StylingExampleComponent;
      });
      /* harmony import */
      ...
      function SelectV2StylingExampleComponent_nui_select_v2_option_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2-option", 2);
      ...
      var SelectV2StylingExampleComponent = function SelectV2StylingExampleComponent() {
        _classCallCheck(this, SelectV2StylingExampleComponent);

        this.items = Array.from({
          length: 100
        }).map(function (_, i) {
          return $localize(_templateObject85 || (_templateObject85 = _taggedTemplateLiteral(["Item ", ""])), i);
        });
        this.config = {
      ...
      SelectV2StylingExampleComponent.ɵfac = function SelectV2StylingExampleComponent_Factory(t) {
        return new (t || SelectV2StylingExampleComponent)();
      };

      SelectV2StylingExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
        type: SelectV2StylingExampleComponent,
        selectors: [["nui-select-v2-styling-example"]],
        hostAttrs: [1, "select-container"],
        decls: 2,
        vars: 2,
        consts: function consts() {
          ...
          if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
            var MSG_EXTERNAL_8325381706328570325$$DEMO_SRC_COMPONENTS_DEMO_SELECT_V2_SELECT_V2_STYLING_SELECT_V2_STYLING_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Select Item");
            ...
            i18n_0 = $localize(_templateObject86 || (_templateObject86 = _taggedTemplateLiteral([":\u241F42daf87f19836ef3d1b8f58a5cf93e2c43b82c1c\u241F8325381706328570325:Select Item"])));
          }

          return [["placeholder", i18n_0, 2, "max-width", "50%", 3, "overlayConfig"], [3, "value", 4, "ngFor", "ngForOf"], [3, "value"]];
        },
        template: function SelectV2StylingExampleComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "nui-select-v2", 0);
    ...
    /***/
    function y2vA(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<form [formGroup]=\"fancyForm\" class=\"nui-edge-definer\" style=\"max-width: 30%;\">\n    <nui-form-field caption=\"Select\" i18n-caption\n                    hint=\"Some pretty long text with hint\" i18n-hint\n                    info=\"text\"\n                    [control]=\"fancyForm.controls['select']\">\n        <nui-select-v2 placeholder=\"Select Item\" i18n-placeholder\n                       formControlName=\"select\">\n            <nui-select-v2-option *ngFor=\"let item of items\" [value]=\"item\">{{item}}</nui-select-v2-option>\n        </nui-select-v2>\n        <nui-validation-message for=\"required\">\n            This field is required\n        </nui-validation-message>\n    </nui-form-field>\n</form>\n";
      /***/
    },
    ...
    /***/
    function zumQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=demo-select-v2-select-v2-module-es5.js.map