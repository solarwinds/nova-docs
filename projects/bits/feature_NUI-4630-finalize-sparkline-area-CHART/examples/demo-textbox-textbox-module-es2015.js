...
TextboxVisualTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TextboxVisualTestComponent, selectors: [["textbox-visual-test"]], decls: 58, vars: 2, consts: function () { let i18n_0; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
    ...
    } return [[1, "container"], [1, "row"], [1, "col"], ["id", "nui-visual-test-textbox-item", "value", "example value"], ["id", "nui-visual-test-placeholder-textbox-item", "placeholder", i18n_0], [1, "w-100"], ["id", "nui-visual-test-disabled-textbox-item", "value", "disabled textbox", "disabled", "true"], ["id", "nui-visual-test-readonly-textbox-item", "value", "readonly textbox", "readonly", "true"], ["id", "nui-visual-test-required-textbox-item", 3, "value", "isInErrorState", "textChange"], ["id", "nui-visual-test-custom-width-textbox-item", "customBoxWidth", "200px"], ["caption", i18n_2, "hint", i18n_4], ["id", "nui-visual-test-hint-textbox-item"], ["caption", i18n_6, "info", i18n_8, "id", "nui-visual-test-info-formfield-item"], ["id", "nui-visual-test-info-textbox-item", "value", "Textbox with info"], ["id", "nui-visual-test-area-textbox-item", "value", "Text area", "rows", "5"], ["id", "nui-visual-test-placeholder-area-textbox-item", "rows", "5", "placeholder", i18n_10]]; }, template: function TextboxVisualTestComponent_Template(rf, ctx) { if (rf & 1) {
...
TextboxAreaExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TextboxAreaExampleComponent, selectors: [["nui-textbox-area-example"]], decls: 1, vars: 0, consts: [["id", "demo-options-area-textbox-item", "value", "Text area", "rows", "5"]], template: function TextboxAreaExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-textbox", 0);
    } }, directives: [_src_lib_textbox_textbox_component__WEBPACK_IMPORTED_MODULE_1__["TextboxComponent"]], encapsulation: 2 });
