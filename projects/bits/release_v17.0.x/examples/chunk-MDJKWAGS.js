import{a as u}from"./chunk-FL4O2KCG.js";import{c as d,g as c}from"./chunk-7HICAA52.js";import{Aa as o,Ib as l,Ob as i,Pb as t,Qb as r,ob as m,qc as e}from"./chunk-7UJBXEVU.js";var E=(()=>{class n{constructor(){this.routesExample=`{
        path: "breadcrumb",
    ...
    }`}static{this.\u0275fac=function(a){return new(a||n)}}static{this.\u0275cmp=o({type:n,selectors:[["nui-breadcrumb-docs-example"]],decls:72,vars:1,consts:[["language","typescript",3,"code"],["href","../injectables/BreadcrumbStateService.html","target","_blank"],["filenamePrefix","breadcrumb-basic","exampleTitle","Basic Usage"]],template:function(a,p){a&1&&(i(0,"p"),e(1," The "),i(2,"code"),e(3,"<nui-breadcrumb>"),t(),e(4,` component represents a structure of nested items. Its state is based on data from each route that takes part in this structure.
...
`),t(),i(70,"nui-example-wrapper",2),r(71,"nui-breadcrumb-basic-example"),t()),a&2&&(m(23),l("code",p.routesExample))},dependencies:[c,d,u],encapsulation:2})}}return n})();export{E as a};
