...
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"add\" iconColor=\"orange\" id=\"nui-demo-icon-color\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconHoverExampleComponent", function() { return IconHoverExampleComponent; });
...
class IconHoverExampleComponent {
}
IconHoverExampleComponent.ɵfac = function IconHoverExampleComponent_Factory(t) { return new (t || IconHoverExampleComponent)(); };
IconHoverExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconHoverExampleComponent, selectors: [["nui-icon-hover-example"]], decls: 1, vars: 0, consts: [["icon", "add", "iconHoverColor", "gray", "id", "nui-demo-icon-hover"]], template: function IconHoverExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-icon", 0);
    } }, directives: [_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__["IconComponent"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"add\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconStatusExampleComponent", function() { return IconStatusExampleComponent; });
...
class IconStatusExampleComponent {
    constructor() {
        this.status = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["IconStatus"].Up;
    }
}
IconStatusExampleComponent.ɵfac = function IconStatusExampleComponent_Factory(t) { return new (t || IconStatusExampleComponent)(); };
IconStatusExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: IconStatusExampleComponent, selectors: [["nui-icon-status-example"]], decls: 1, vars: 1, consts: [["icon", "add", "id", "nui-demo-icon-with-status-up", 3, "status"]], template: function IconStatusExampleComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_2__["IconComponent"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconChildStatusExampleComponent", function() { return IconChildStatusExampleComponent; });
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nova-ui/bits */ "b5Xb");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");
...
class IconChildStatusExampleComponent {
    constructor() {
        this.status = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["IconStatus"].Up;
        this.childStatus = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["IconStatus"].Sleep;
    }
}
IconChildStatusExampleComponent.ɵfac = function IconChildStatusExampleComponent_Factory(t) { return new (t || IconChildStatusExampleComponent)(); };
IconChildStatusExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: IconChildStatusExampleComponent, selectors: [["nui-icon-child-status-example"]], decls: 1, vars: 2, consts: [["icon", "add", 3, "status", "childStatus"]], template: function IconChildStatusExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "nui-icon", 0);
    } if (rf & 2) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconColorExampleComponent", function() { return IconColorExampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");


class IconColorExampleComponent {
}
IconColorExampleComponent.ɵfac = function IconColorExampleComponent_Factory(t) { return new (t || IconColorExampleComponent)(); };
IconColorExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconColorExampleComponent, selectors: [["nui-icon-color-example"]], decls: 1, vars: 0, consts: [["icon", "add", "iconColor", "orange", "id", "nui-demo-icon-color"]], template: function IconColorExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-icon", 0);
    } }, directives: [_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__["IconComponent"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconCounterExampleComponent", function() { return IconCounterExampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");


class IconCounterExampleComponent {
}
IconCounterExampleComponent.ɵfac = function IconCounterExampleComponent_Factory(t) { return new (t || IconCounterExampleComponent)(); };
IconCounterExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconCounterExampleComponent, selectors: [["nui-icon-counter-example"]], decls: 1, vars: 1, consts: [["icon", "email", "id", "nui-demo-icon-with-counter", 3, "counter"]], template: function IconCounterExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-icon", 0);
    } if (rf & 2) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"add\" [status]=\"status\" [childStatus]=\"childStatus\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"add\" [status]=\"status\" id=\"nui-demo-icon-with-status-up\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"add\" iconHoverColor=\"gray\" id=\"nui-demo-icon-hover\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconDocsExampleComponent", function() { return IconDocsExampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
/* harmony import */ var _icon_basic_icon_basic_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../icon-basic/icon-basic.example.component */ "uYeo");
/* harmony import */ var _icon_size_icon_size_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../icon-size/icon-size.example.component */ "fOJQ");
/* harmony import */ var _icon_color_icon_color_example_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../icon-color/icon-color.example.component */ "5zsC");
/* harmony import */ var _icon_hover_icon_hover_example_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../icon-hover/icon-hover.example.component */ "+mSZ");
/* harmony import */ var _icon_status_icon_status_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../icon-status/icon-status.example.component */ "2j0N");
/* harmony import */ var _icon_child_status_icon_child_status_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../icon-child-status/icon-child-status.example.component */ "43X2");
/* harmony import */ var _icon_with_text_icon_with_text_example_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../icon-with-text/icon-with-text.example.component */ "TaXb");
/* harmony import */ var _icon_counter_icon_counter_example_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../icon-counter/icon-counter.example.component */ "6lY8");
/* harmony import */ var _icon_list_icon_list_example_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../icon-list/icon-list.example.component */ "hYYR");
...
class IconDocsExampleComponent {
}
IconDocsExampleComponent.ɵfac = function IconDocsExampleComponent_Factory(t) { return new (t || IconDocsExampleComponent)(); };
IconDocsExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconDocsExampleComponent, selectors: [["nui-icon-docs-example"]], decls: 117, vars: 0, consts: [["filenamePrefix", "icon-basic", "exampleTitle", "Basic Usage"], ["filenamePrefix", "icon-size", "exampleTitle", "Size"], ["filenamePrefix", "icon-color", "exampleTitle", "Color"], ["filenamePrefix", "icon-hover", "exampleTitle", "Hover effect"], ["href", "../miscellaneous/enumerations.html#IconStatus", "target", "_blank"], ["filenamePrefix", "icon-status", "exampleTitle", "Status"], ["filenamePrefix", "icon-child-status", "exampleTitle", "Child Status"], ["filenamePrefix", "icon-with-text", "exampleTitle", "Alignment with Text"], ["filenamePrefix", "icon-counter", "exampleTitle", "Counter"], ["filenamePrefix", "icon-list", "exampleTitle", "Available Icons"]], template: function IconDocsExampleComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nui-icon icon=\"email\" [counter]=\"6\" id=\"nui-demo-icon-with-counter\"></nui-icon>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconWithTextExampleComponent", function() { return IconWithTextExampleComponent; });
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nova-ui/bits */ "b5Xb");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");
...
class IconWithTextExampleComponent {
    constructor() {
        this.status = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["IconStatus"].Up;
        this.childStatus = _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__["IconStatus"].Sleep;
    }
}
IconWithTextExampleComponent.ɵfac = function IconWithTextExampleComponent_Factory(t) { return new (t || IconWithTextExampleComponent)(); };
IconWithTextExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: IconWithTextExampleComponent, selectors: [["nui-icon-with-text-example"]], decls: 4, vars: 2, consts: function () { let i18n_0; if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_EXTERNAL_5754806911956338696$$DEMO_SRC_COMPONENTS_DEMO_ICON_ICON_WITH_TEXT_ICON_WITH_TEXT_EXAMPLE_COMPONENT_TS_1 = goog.getMsg("Managed entity name");
        ...
        i18n_0 = $localize `:␟80febca9e183c54f0226e9fed02be69e65adba88␟5754806911956338696:Managed entity name`;
    } return [[1, "d-inline-flex", "align-items-center"], ["icon", "printer", 3, "status", "childStatus"], i18n_0]; }, template: function IconWithTextExampleComponent_Template(rf, ctx) { if (rf & 1) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconSizeExampleComponent", function() { return IconSizeExampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");


class IconSizeExampleComponent {
}
IconSizeExampleComponent.ɵfac = function IconSizeExampleComponent_Factory(t) { return new (t || IconSizeExampleComponent)(); };
IconSizeExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconSizeExampleComponent, selectors: [["nui-icon-size-example"]], decls: 3, vars: 0, consts: [["icon", "add", "iconSize", "small", "id", "nui-demo-icon-small"], ["icon", "add", "id", "nui-demo-icon-default-size"], ["icon", "add", "iconSize", "medium", "id", "nui-demo-icon-medium-size"]], template: function IconSizeExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-icon", 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconListExampleComponent", function() { return IconListExampleComponent; });
/* harmony import */ var _src_lib_icon_icons__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icons */ "0r6c");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _src_lib_expander_expander_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../../../../src/lib/expander/expander.component */ "j4OC");
...
function IconListExampleComponent_div_0_div_3_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const icon_r3 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
...
function IconListExampleComponent_div_0_div_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const category_r1 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵnextContext"]().$implicit;
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵadvance"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngIf", icon_r3.code && icon_r3.category == category_r1);
} }
function IconListExampleComponent_div_0_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "div");
...
class IconListExampleComponent {
    ngOnInit() {
...
IconListExampleComponent.ɵfac = function IconListExampleComponent_Factory(t) { return new (t || IconListExampleComponent)(); };
IconListExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: IconListExampleComponent, selectors: [["nui-icon-list-example"]], decls: 1, vars: 1, consts: [[4, "ngFor", "ngForOf"], [3, "header"], [1, "row", "align-items-baseline"], ["class", "m-3", 4, "ngIf"], [1, "m-3"], [1, "d-flex", "flex-column", "align-items-center"], [3, "icon"], [1, "mt-2"]], template: function IconListExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtemplate"](0, IconListExampleComponent_div_0_Template, 4, 2, "div", 0);
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵproperty"]("ngForOf", ctx.categories);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["NgForOf"], _src_lib_expander_expander_component__WEBPACK_IMPORTED_MODULE_3__["ExpanderComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_2__["NgIf"], _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_4__["IconComponent"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _icon_basic_icon_basic_example_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./icon-basic/icon-basic.example.component */ "uYeo");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconBasicExampleComponent", function() { return _icon_basic_icon_basic_example_component__WEBPACK_IMPORTED_MODULE_0__["IconBasicExampleComponent"]; });

/* harmony import */ var _icon_docs_icon_docs_example_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./icon-docs/icon-docs.example.component */ "K3+M");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconDocsExampleComponent", function() { return _icon_docs_icon_docs_example_component__WEBPACK_IMPORTED_MODULE_1__["IconDocsExampleComponent"]; });

/* harmony import */ var _icon_color_icon_color_example_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./icon-color/icon-color.example.component */ "5zsC");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconColorExampleComponent", function() { return _icon_color_icon_color_example_component__WEBPACK_IMPORTED_MODULE_2__["IconColorExampleComponent"]; });

/* harmony import */ var _icon_list_icon_list_example_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./icon-list/icon-list.example.component */ "hYYR");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconListExampleComponent", function() { return _icon_list_icon_list_example_component__WEBPACK_IMPORTED_MODULE_3__["IconListExampleComponent"]; });

/* harmony import */ var _icon_size_icon_size_example_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./icon-size/icon-size.example.component */ "fOJQ");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconSizeExampleComponent", function() { return _icon_size_icon_size_example_component__WEBPACK_IMPORTED_MODULE_4__["IconSizeExampleComponent"]; });

/* harmony import */ var _icon_status_icon_status_example_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./icon-status/icon-status.example.component */ "2j0N");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconStatusExampleComponent", function() { return _icon_status_icon_status_example_component__WEBPACK_IMPORTED_MODULE_5__["IconStatusExampleComponent"]; });

/* harmony import */ var _icon_hover_icon_hover_example_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./icon-hover/icon-hover.example.component */ "+mSZ");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconHoverExampleComponent", function() { return _icon_hover_icon_hover_example_component__WEBPACK_IMPORTED_MODULE_6__["IconHoverExampleComponent"]; });

/* harmony import */ var _icon_counter_icon_counter_example_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./icon-counter/icon-counter.example.component */ "6lY8");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconCounterExampleComponent", function() { return _icon_counter_icon_counter_example_component__WEBPACK_IMPORTED_MODULE_7__["IconCounterExampleComponent"]; });

/* harmony import */ var _icon_child_status_icon_child_status_example_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./icon-child-status/icon-child-status.example.component */ "43X2");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconChildStatusExampleComponent", function() { return _icon_child_status_icon_child_status_example_component__WEBPACK_IMPORTED_MODULE_8__["IconChildStatusExampleComponent"]; });

/* harmony import */ var _icon_with_text_icon_with_text_example_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./icon-with-text/icon-with-text.example.component */ "TaXb");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconWithTextExampleComponent", function() { return _icon_with_text_icon_with_text_example_component__WEBPACK_IMPORTED_MODULE_9__["IconWithTextExampleComponent"]; });

/* harmony import */ var _icon_visual_test_icon_visual_test_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./icon-visual-test/icon-visual-test.component */ "x3G+");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IconVisualTestComponent", function() { return _icon_visual_test_icon_visual_test_component__WEBPACK_IMPORTED_MODULE_10__["IconVisualTestComponent"]; });
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index */ "iFCb");
...
IconModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineInjector"]({ factory: function IconModule_Factory(t) { return new (t || IconModule)(); }, providers: [
        {
            provide: _nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["DEMO_PATH_TOKEN"],
            useFactory: () => __webpack_require__("BqlG"),
        },
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵsetNgModuleScope"](IconModule, { declarations: [_index__WEBPACK_IMPORTED_MODULE_2__["IconBasicExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconChildStatusExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconColorExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconCounterExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconDocsExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconListExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconSizeExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconStatusExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconHoverExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconWithTextExampleComponent"],
        _index__WEBPACK_IMPORTED_MODULE_2__["IconVisualTestComponent"]], imports: [_nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiIconModule"],
        _nova_ui_bits__WEBPACK_IMPORTED_MODULE_1__["NuiExpanderModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconBasicExampleComponent", function() { return IconBasicExampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icon.component */ "45Bz");
...
IconBasicExampleComponent.ɵfac = function IconBasicExampleComponent_Factory(t) { return new (t || IconBasicExampleComponent)(); };
IconBasicExampleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: IconBasicExampleComponent, selectors: [["nui-icon-basic-example"]], decls: 1, vars: 0, consts: [["icon", "add"]], template: function IconBasicExampleComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "nui-icon", 0);
    } }, directives: [_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_1__["IconComponent"]], encapsulation: 2 });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IconVisualTestComponent", function() { return IconVisualTestComponent; });
/* harmony import */ var _nova_ui_bits__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nova-ui/bits */ "b5Xb");
/* harmony import */ var _src_lib_icon_icons__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../../src/lib/icon/icons */ "0r6c");
...
function IconVisualTestComponent_div_37_Template(rf, ctx) { if (rf & 1) {
...
function IconVisualTestComponent_div_43_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵelementStart"](0, "div", 6);
    _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵtext"](1);
...
IconVisualTestComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: IconVisualTestComponent, selectors: [["nui-icon-visual-test"]], decls: 57, vars: 3, consts: [[1, "ml-4"], ["icon", "add", "iconHoverColor", "gray", "id", "nui-icon-test-basic-usage"], ["icon", "add", "iconSize", "small", "id", "nui-icon-test-small-size", 1, "pr-2"], ["icon", "add", "id", "nui-icon-test-default-size", 1, "pr-2"], ["icon", "add", "iconSize", "medium", "id", "nui-icon-test-medium-size", 1, "pr-2"], [1, "d-flex", "flex-row"], [1, "d-flex", "flex-column", "pr-5"], ["icon", "add", "iconColor", "orange", "id", "nui-icon-test-color"], ["icon", "add", "iconColor", "light-blue", "id", "nui-icon-test-color"], ["icon", "add", "iconColor", "primary-blue", "id", "nui-icon-test-color"], ["icon", "add", "iconColor", "gray", "id", "nui-icon-test-color"], ["icon", "add", "iconColor", "disabled-gray", "id", "nui-icon-test-color"], ["class", "d-flex flex-column pr-5", 4, "ngFor", "ngForOf"], [1, "d-inline-flex", "align-items-center"], ["icon", "printer", "status", "critical", "childStatus", "down"], ["icon", "email", "id", "nui-icon-test-with-counter", 3, "counter"], ["icon", "add", 3, "status"], ["icon", "add", "status", "up", 3, "childStatus"]], template: function IconVisualTestComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_src_lib_icon_icon_component__WEBPACK_IMPORTED_MODULE_3__["IconComponent"], _angular_common__WEBPACK_IMPORTED_MODULE_4__["NgForOf"]], encapsulation: 2 });
...
//# sourceMappingURL=demo-icon-icon-module-es2015.js.map