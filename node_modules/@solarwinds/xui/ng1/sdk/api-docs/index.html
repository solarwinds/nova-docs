...
<!--[if gt IE 8]><!--> <html class="no-js xui" ng-app="docsApp"  lang="en" ng-controller="DocsController"> <!--<![endif]-->
<head>
  <meta charset="utf-8">
  ...
  <title ng-bind-template="XUI powered by SolarWinds: {{partialTitle}}">Docs</title>
  <script type="text/javascript">
    ...
    (function() {
      ...
      addTag('base', {href: baseUrl});
         ...
         addTag('link', {rel: 'stylesheet', href: 'css/vendor.css', type: 'text/css'}, sync);
      
         addTag('link', {rel: 'stylesheet', href: 'css/xui.css', type: 'text/css'}, sync);
      
         addTag('link', {rel: 'stylesheet', href: 'css/demo.css', type: 'text/css'}, sync);
      
         addTag('link', {rel: 'stylesheet', href: 'css/ng_docs.css', type: 'text/css'}, sync);
      ...
      addTag('script', {src: 'js/marked.js'}, sync);
        ...
        addTag('script', {src: 'js/xui.js'}, sync);
      
        addTag('script', {src: 'js/translations.js'}, sync);
      
        addTag('script', {src: 'js/misc.js'}, sync);
      
        addTag('script', {src: 'js/angular-bootstrap-prettify_modified.js'}, sync);
...
<body>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
              ...
              <img class="pull-left xui-sw-logo" src="img/SolarWinds.Logo.Footer.svg">
            
              </a>
            
          
          
            <a  href="https://github.com/solarwinds/Xui"  class="brand">XUI powered by SolarWinds</a>
            <span class="xui-version">BUILDMEISTER_VERSION_FULL</span>
  ...
  <div class="xui-demo-footer">Copyright SolarWinds 2015-_CURRENT_YEAR_</div>
</body>
</html>
