...
<html lang="en">
<head>
    <title>Code coverage report for src/components/grid</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> src/components/grid
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">81.03% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>141/174</span>
      </div>
      <div class='fl pad1y space-right2'>
...
<tbody><tr>
	<td class="file high" data-value="grid-controller.ts"><a href="grid-controller.ts.html">grid-controller.ts</a></td>
	<td data-value="82.3" class="pic high"><div class="chart"><div class="cover-fill" style="width: 82%;"></div><div class="cover-empty" style="width:18%;"></div></div></td>
	<td data-value="82.3" class="pct high">82.3%</td>
	<td data-value="113" class="abs high">93/113</td>
	...
	<td data-value="108" class="abs high">88/108</td>
	</tr>

<tr>
	<td class="file high" data-value="grid-directive.ts"><a href="grid-directive.ts.html">grid-directive.ts</a></td>
...
<tr>
	<td class="file medium" data-value="grid-service.ts"><a href="grid-service.ts.html">grid-service.ts</a></td>
...
<tr>
	<td class="file high" data-value="gridToolbarContainer-directive.ts"><a href="gridToolbarContainer-directive.ts.html">gridToolbarContainer-directive.ts</a></td>
...
<tr>
	<td class="file medium" data-value="gridToolbarTransclude-directive.ts"><a href="gridToolbarTransclude-directive.ts.html">gridToolbarTransclude-directive.ts</a></td>
