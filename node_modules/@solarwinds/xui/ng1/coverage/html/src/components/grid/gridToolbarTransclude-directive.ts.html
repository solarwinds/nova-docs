...
<html lang="en">
<head>
    <title>Code coverage report for src/components/grid/gridToolbarTransclude-directive.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/components/grid</a> gridToolbarTransclude-directive.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        if (filteredListCtrl &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >filteredListCtrl.t</span>oolbarTranscluded) {
            element.html("");
            element.append(filteredListCtrl.toolbarTranscluded);
        <span class="missing-if-branch" title="if path not taken" >I</span>}<span class="branch-1 cbranch-no" title="branch not covered" > else<span class="cstat-no" title="statement not covered" > if (gridCtrl &amp;&amp; g</span>ridCtrl.toolbarTranscluded) {</span>
