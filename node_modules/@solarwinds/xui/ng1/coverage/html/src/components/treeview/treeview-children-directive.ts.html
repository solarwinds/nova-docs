...
<html lang="en">
<head>
    <title>Code coverage report for src/components/treeview/treeview-children-directive.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> / <a href="index.html">src/components/treeview</a> treeview-children-directive.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ITreeviewController = xui.ITreeviewController;
&nbsp;
...
&nbsp;
        return {
            post: (scope: ng.IScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes,
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if (ctrl.options.limit == null) {
<span class="cstat-no" title="statement not covered" >                    template</span>.find(".xui-treeview-limit-links").remove();
                }
                if (ctrl.options.load == null) {
                    template.find(".xui-treeview-spinner").remove();
                }
                <span class="missing-if-branch" title="else path not taken" >E</span>let compiled = this.$compile(template.html())(scope);
