...
<html lang="en">
<head>
    <title>Code coverage report for src/components/empty</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> src/components/empty
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file high" data-value="empty-controller.ts"><a href="empty-controller.ts.html">empty-controller.ts</a></td>
...
<tr>
	<td class="file low" data-value="empty-directive.ts"><a href="empty-directive.ts.html">empty-directive.ts</a></td>
