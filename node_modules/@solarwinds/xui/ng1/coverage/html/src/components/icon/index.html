...
<html lang="en">
<head>
    <title>Code coverage report for src/components/icon</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">All files</a> src/components/icon
    </h1>
    <div class='clearfix'>
...
<tbody><tr>
	<td class="file medium" data-value="icon-directive.ts"><a href="icon-directive.ts.html">icon-directive.ts</a></td>
