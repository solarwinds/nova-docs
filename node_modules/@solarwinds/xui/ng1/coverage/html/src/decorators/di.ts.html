...
<html lang="en">
<head>
    <title>Code coverage report for src/decorators/di.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/decorators</a> di.ts
    </h1>
    <div class='clearfix'>
...
export default function Inject(dependency:string) {
    return (prototype:Function, method:string | symbol, argumentPosition:number) =&gt; {
