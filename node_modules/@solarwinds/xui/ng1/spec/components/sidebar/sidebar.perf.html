<form>
    <div class="xui xui-demo-sidebar-container" id="sidebar-page" ng-controller="PerfSidebarController as vm">
        <div class="row">
            <xui-sidebar-container>
                <xui-sidebar settings="vm.settings">
                    <div class="col-sm-offset-11">
                        <xui-button display-style="tertiary" icon="close" ng-click="vm.hide()"></xui-button>
                    </div>
                    <div>{{vm.dynamicContent}}</div>
                </xui-sidebar>

                <div class="col-sm-offset-5">
                    <xui-button ng-click="vm.toggleSidebar()">Toggle sidebar {{vm.settings.position}}</xui-button>
                    <br/>
                    <h3>Position:</h3>
                    <div>
                        <xui-radio ng-model="vm.settings.position" value="right">Right</xui-radio>
                        <xui-radio ng-model="vm.settings.position" value="left">Left</xui-radio>
                    </div>
                </div>
            </xui-sidebar-container>
        </div>
...
<script type="text/javascript">
    ...
    (function () {
        ...
        Xui.controller("PerfSidebarController", PerfSidebarController, ["$scope", "perfService"]);

        function PerfSidebarController($scope, perfService) {
            var vm = this;
            ...
            vm.toggleSidebar = function () {
                vm.settings.display = !vm.settings.display;
            };

            vm.hide = function () {
                vm.settings.display = false;
            };

            vm.dynamicContent = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras at viverra orci. ' +
                ...
                'Donec consectetur libero eget bibendum consequat. Donec tincidunt molestie viverra. ' +
