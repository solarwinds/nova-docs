<div class="xui" ng-controller="ScrollbarController as vm">
    <div>
        <h3>Lorem Ipsum</h3>
        <div id="scrollbarMockHV" style="position:relative;
                    max-height:200px;
                    max-width:660px;
                    overflow:auto;
                    border:solid 1px #d9d9d9;
                    padding:8px 8px;" xui-scrollbar>
            <div style="height:300px;
                        width:1024px;
                        margin-right:25px;">{{vm.content}}</div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    (function () {
        ...
        Xui.controller("ScrollbarController", ScrollbarController, ["$scope", "perfService"]);

        function ScrollbarController($scope, perfService) {
