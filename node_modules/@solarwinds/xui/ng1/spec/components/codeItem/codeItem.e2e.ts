import { by, browser, element } from "@solarwinds/uzi/protractor";
...
describe("USERCONTROL code item: ", () => {
    ...
    beforeEach(() => {
        Helpers.prepareBrowser("codeItem");

        listView_case1 = Atom.findIn(ListViewAtom, element(by.id("listview_004")));
        listView_case2 = Atom.findIn(ListViewAtom, element(by.id("listview_006")));
        listView_case3 = Atom.findIn(ListViewAtom, element(by.id("listview_008")));
    ...
    it("should not be able to select line numbers (checked using ctrl+a)", async ()=> {
        ...
        browser.executeScript(() => {
            ...
            _.each(document.querySelectorAll(".example"),
