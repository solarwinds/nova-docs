.xui body { background-color: #f1f1f1; }
...
.navbar-inner .xui-sw-logo{
    height: 40px;
}

.navbar-inner .xui-version{
    display: block;
    float: right;
...
.navbar-inner {
    ...
    background-image: -moz-linear-gradient(top, #1d1d1d, #3d3d3d);
    background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#1d1d1d), to(#3d3d3d));
    background-image: -webkit-linear-gradient(top, #1d1d1d, #3d3d3d);
    background-image: -o-linear-gradient(top, #1d1d1d, #3d3d3d);
    background-image: linear-gradient(to bottom, #1d1d1d, #3d3d3d);
...
.type-hint-boolean {
  background:rgb(18, 131, 39)  !important;
}

.type-hint-number {
  background:rgb(189, 63, 66)  !important;
}
