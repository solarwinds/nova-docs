...
.xui .xui-checkbox {
    ...
    &.xui-checkbox--has-action .xui-checkbox__mark:after {
        display: none;
    }
    ...
    &__input {
        ...
        &:indeterminate + .xui-checkbox__mark {
    ...
    &.xui-checkbox--no-shadow {
        ...
        .xui-checkbox__input {
            &.xui-checkbox__input--hovered + .xui-checkbox__mark,
            &:active + .xui-checkbox-mark,
            &:focus + .xui-checkbox-mark {
                .box-shadow(none);
            }
        }
