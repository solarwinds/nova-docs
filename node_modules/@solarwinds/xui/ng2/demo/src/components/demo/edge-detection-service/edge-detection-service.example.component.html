<div class="xui">
    <div id="xui-demo-services-edge-detection">
        ...
        <div>
                    ...
                    <ul>
                        <li>
                            <xui-textbox
                                    ...
                                    name="element-name"
                                    [value]="deposit.width"
                                    (textChange)="changeText('deposit.width', $event)"
                                    ngDefaultControl>
                            </xui-textbox>
                        </li>
                        <li>
                            <xui-textbox
                                    ...
                                    (textChange)="changeText('deposit.height', $event)"
                                    ngDefaultControl>
                            </xui-textbox>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <xui-textbox
                                    ...
                                    (textChange)="changeText('parentComponent.width', $event)"
                        ...
                        <li>
                            <xui-textbox
                                    ...
                                    (textChange)="changeText('parentComponent.height', $event)"
                                    [disabled]="!addEdgeDefinerClass"
                                    ngDefaultControl>
                            </xui-textbox>
                        </li>
            ...
            <button xui-button (click)="update()">Calculate place</button>
            <br>
            <h2>Results</h2>
            ...
            <div class="col-md-12">
                ...
                <xui-checkbox name="parent-class"
                              [value]="addEdgeDefinerClass"
                              (valueChange)="switchCheckbox()"
                              ngDefaultControl>
                    Add xui-edge-definer class to parent component
                </xui-checkbox>
            </div>
            <br>
            <div #parent
