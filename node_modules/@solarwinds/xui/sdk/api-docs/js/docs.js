...
docsApp.serviceFactory.openPlunkr = function (templateMerge, formPostData, loadedUrls) {
    return function (content) {
        ...
        function isValidDep(url) {
            var ignoreList = [
                "marked.js",
                "translations.js",
                "misc.js",
                "angular-bootstrap-prettify_modified.js",
                "demo.css",
                "ng_docs.css",
                "localhost:8282",
                "_xui-css-url_"
        ...
        angular.forEach(styleSheetList, function (style) {
            if (style.href && isValidDep(style.href)) {
                scriptDeps += '    <link rel="stylesheet" href="' + style.href + '" type="text/css">\n';
            }
        });
...
docsApp.controller.DocsController = function($scope, $location, $window, sections) {
  ...
  $scope.$watch(function docsPathWatch() {return $location.hash(); }, function docsPathWatchAction(path) {
